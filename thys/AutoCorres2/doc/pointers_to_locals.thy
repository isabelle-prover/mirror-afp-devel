...
thm call_inc_local_uninitialized'_def

text \<open>Pointer to an initialized local variable.\<close>
thm call_inc_local_initialized'_def
...
\<close>
thm call_inc_untyp'_def

text \<open>Nested pointers among the phases.\<close>

thm call_inc_nested_body_def

thm l1_call_inc_nested'_def
thm l2_call_inc_nested'_def
thm hl_call_inc_nested'_def
thm wa_call_inc_nested'_def
thm call_inc_nested'_def

text \<open>Global variable\<close>
thm call_inc_global'_def

text \<open>Local array variable.\<close>
thm call_inc_array'_def


text \<open>Local structure variable.\<close>

thm call_inc_first'_def

text \<open>Local array in structure variable.\<close>
thm call_inc_buffer'_def
...
context pointers_to_locals_global_addresses begin
