...
proof -
  have "fmrestrict_set vs s \<subseteq>\<^sub>f s" 
    using FmapUtils.fmrestrict_subset
    by blast
...
proof -
  ...
  "
    using 1 graph_plan_lemma_4[where 
      ...
      exec_plan.simps(1) drestrict_empty_iff_disj list_all_list_mem
    by smt
  ...
  "
    by fastforce
  then show ?thesis
    using 1 vset_diff_disj_eff_vs disjoint_effects_no_effects drestrict_empty_iff_disj
    by metis
qed
