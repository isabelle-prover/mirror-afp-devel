...
imports
  ...
  "../Berlekamp_Zassenhaus/Bivariate_Polynomials"
...
proof -
  ...
  show ?thesis unfolding poly_add_def
    apply (subst mh.resultant_map_poly(1))
...
proof(rule ccontr)
  ...
  from F f p_0 have f_0: "poly f 0 \<noteq> 0" by (auto simp: poly_prod_mset_zero_iff)
