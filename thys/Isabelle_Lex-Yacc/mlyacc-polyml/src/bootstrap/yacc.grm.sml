...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | ID of unit ->  (string*Header.pos) | HEADER of unit ->  (string)
 | TY of unit ->  (string)
 ...
 | RHS_LIST of unit ->  ({ rhs:Hdr.symbol list,code:{ text:string,pos:Header.pos } ,prec:Hdr.symbol option }  list)
...
|  ( 37, ( ( _, ( MlyValue.PROG PROG1, PROGleft, PROG1right)) :: ( _, 
...
MlyValue.RHS_LIST (fn _ => let val  (ID_LIST as ID_LIST1) = ID_LIST1
 ...
 val  (PROG as PROG1) = PROG1 ()
 in ([{rhs=ID_LIST,code={text=PROG,pos=PROGleft},prec=G_RULE_PREC}])

end)
 in ( LrTable.NT 8, ( result, ID_LIST1left, PROG1right), rest671)
end
|  ( 38, ( ( _, ( MlyValue.PROG PROG1, PROGleft, PROG1right)) :: ( _, 
( MlyValue.G_RULE_PREC G_RULE_PREC1, _, _)) :: ( _, ( MlyValue.ID_LIST
