...
Various important theta nullwert identities are also derived, e.g.\ 
$\vartheta_2(q)^4 + \vartheta_4(q)^4 = \vartheta_3(q)^4$ and $\vartheta_1'(q) = \vartheta_2(q) \vartheta_3(q)
\vartheta_4(q)$.
\end{abstract}
