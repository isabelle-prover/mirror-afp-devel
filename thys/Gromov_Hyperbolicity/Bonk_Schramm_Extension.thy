...
theory Bonk_Schramm_Extension
  imports "HOL-Cardinals.Cardinal_Order_Relation" Gromov_Hyperbolicity
begin

section \<open>Preliminaries on well-orders\<close>

text \<open>In this section, we give additional lemmas on well-orders or cardinals or whatever,
...
section \<open>Construction of the Bonk Schramm extension\<close>
