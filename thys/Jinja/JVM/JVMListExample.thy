(*  Title:      HOL/MicroJava/JVM/JVMListExample.thy
    ID:         $Id: JVMListExample.thy,v 1.2 2005-09-06 15:06:08 makarius Exp $
...
ML {*
fun new_addr p none loc h =
  let fun nr i = if p (h (loc i)) then (loc i, none) else nr (i+1);
  in nr 0 end;
*}
