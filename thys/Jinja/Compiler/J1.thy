...
consts
  eval\<^isub>1  :: "J\<^isub>1_prog \<Rightarrow> ((expr\<^isub>1 \<times> state\<^isub>1) \<times> (expr\<^isub>1 \<times> state\<^isub>1)) set"
  evals\<^isub>1  :: "J\<^isub>1_prog \<Rightarrow> ((expr\<^isub>1 list \<times> state\<^isub>1) \<times> (expr\<^isub>1 list \<times> state\<^isub>1)) set"

(*<*)
syntax (xsymbols)
  eval\<^isub>1 :: "J\<^isub>1_prog \<Rightarrow> expr \<Rightarrow> state\<^isub>1 \<Rightarrow> nat \<Rightarrow> expr \<Rightarrow> state\<^isub>1 \<Rightarrow> bool"
          ("_ \<turnstile>\<^sub>1 ((1\<langle>_,/_\<rangle>) \<Rightarrow>/ (1\<langle>_,/_\<rangle>))" [51,0,0,0,0] 81)
  evals\<^isub>1 :: "J\<^isub>1_prog \<Rightarrow> expr list \<Rightarrow> state\<^isub>1 \<Rightarrow> nat \<Rightarrow> expr list \<Rightarrow> state\<^isub>1 \<Rightarrow> bool"
           ("_ \<turnstile>\<^sub>1 ((1\<langle>_,/_\<rangle>) [\<Rightarrow>]/ (1\<langle>_,/_\<rangle>))" [51,0,0,0,0] 81)
(*>*)

translations
  "P \<turnstile>\<^sub>1 \<langle>e,s\<rangle> \<Rightarrow> \<langle>e',s'\<rangle>" == "((e,s), e',s') \<in> eval\<^isub>1 P"
  "P \<turnstile>\<^sub>1 \<langle>e,s\<rangle> [\<Rightarrow>] \<langle>e',s'\<rangle>" == "((e,s), e',s') \<in> evals\<^isub>1 P"
(*<*)
  "P \<turnstile>\<^sub>1 \<langle>e,(h,l)\<rangle> \<Rightarrow> \<langle>e',(h',l')\<rangle>" <= "((e,h,l), e',h',l') \<in> eval\<^isub>1 P"
  "P \<turnstile>\<^sub>1 \<langle>e,s\<rangle> \<Rightarrow> \<langle>e',(h',l')\<rangle>" <= "((e,s), e',h',l') \<in> eval\<^isub>1 P"
  "P \<turnstile>\<^sub>1 \<langle>e,(h,l)\<rangle> \<Rightarrow> \<langle>e',s'\<rangle>" <= "((e,h,l), e',s') \<in> eval\<^isub>1 P"
  "P \<turnstile>\<^sub>1 \<langle>e,(h,l)\<rangle> [\<Rightarrow>] \<langle>e',(h',l')\<rangle>" <= "((e,h,l), e',h',l') \<in> evals\<^isub>1 P"
  "P \<turnstile>\<^sub>1 \<langle>e,s\<rangle> [\<Rightarrow>] \<langle>e',(h',l')\<rangle>" <= "((e,s), e',h',l') \<in> evals\<^isub>1 P"
  "P \<turnstile>\<^sub>1 \<langle>e,(h,l)\<rangle> [\<Rightarrow>] \<langle>e',s'\<rangle>" <= "((e,h,l), e',s') \<in> evals\<^isub>1 P"
(*>*)


inductive "eval\<^isub>1 P" "evals\<^isub>1 P"
intros
...
apply (auto elim:eval\<^isub>1_evals\<^isub>1.elims)
done
(*>*)
