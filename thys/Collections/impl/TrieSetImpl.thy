...
definition ts_empty :: "unit \<Rightarrow> 'a ts" 
...
definition ts_iteratei :: "'a ts \<Rightarrow> ('a list,'\<sigma>) set_iterator" 
...
definition ts_inter :: "'a ts \<Rightarrow> 'a ts \<Rightarrow> 'a ts" 
  where "ts_inter == it_inter ts_iteratei ts_memb ts_empty ts_ins_dj"

definition ts_size :: "'a ts \<Rightarrow> nat"
where "ts_size == it_size ts_iteratei"

definition ts_image_filter 
  where "ts_image_filter == it_image_filter ts_iteratei ts_empty ts_ins"

definition ts_inj_image_filter 
  where "ts_inj_image_filter == it_inj_image_filter ts_iteratei ts_empty ts_ins_dj"
...
definition "ts_to_list == it_set_to_list ts_iteratei"
...
lemmas ts_inter_impl = it_inter_correct[OF ts_iteratei_impl ts_memb_impl ts_empty_impl ts_ins_dj_impl, folded ts_inter_def]
lemmas ts_size_impl = it_size_correct[OF ts_iteratei_impl, folded ts_size_def]
lemmas ts_image_filter_impl = it_image_filter_correct[OF ts_iteratei_impl ts_empty_impl ts_ins_impl, folded ts_image_filter_def]
lemmas ts_inj_image_filter_impl = it_inj_image_filter_correct[OF ts_iteratei_impl ts_empty_impl ts_ins_dj_impl, folded ts_inj_image_filter_def]
...
lemmas ts_to_list_impl = it_set_to_list_correct[OF ts_iteratei_impl, folded ts_to_list_def]
