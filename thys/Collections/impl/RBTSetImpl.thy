...
definition rs_empty :: "unit \<Rightarrow> 'a::linorder rs" where "rs_empty == s_empty rm_empty"
...
definition rs_iteratei :: "'a::linorder rs \<Rightarrow> ('a,'\<sigma>) set_iterator" 
  where "rs_iteratei == s_iteratei rm_iteratei"

definition rs_iterateoi :: "'a::linorder rs \<Rightarrow> ('a,'\<sigma>) set_iterator" 
  where "rs_iterateoi == s_iteratei rm_iterateoi"

definition rs_reverse_iterateoi :: "'a::linorder rs \<Rightarrow> ('a,'\<sigma>) set_iterator" 
