...
(*#patterns
 ...
 SetGA.it_diff@set_diff: (x:set)iterate (y:set)delete \<Rightarrow> (y,x)diff
 SetGA.ei_sng@set_sng: (x:set)empty (x)ins \<Rightarrow> (x)sng

 SetGA.it_size@set_size: (x:set)iterate \<Rightarrow> (x)size
 SetGA.iti_size_abort@set_size_abort: (x:set)iteratei \<Rightarrow> (x)size_abort
 SetGA.sza_isSng@set_isSng: (x:set)size_abort \<Rightarrow> (x)isSng
 ...
 SetGA.image_filter_cartesian_product@!: (x:set)iterate (y:set)iterate (z:set)empty (z)ins \<Rightarrow> (x,y,z)image_filter_cartesian_product
 SetGA.inj_image_filter_cartesian_product@!: (x:set)iterate (y:set)iterate (z:set)empty (z)ins_dj \<Rightarrow> (x,y,z)inj_image_filter_cartesian_product
 ...
 it_dom_fun_to_map@!: (x:set)iterate (y:map)update_dj (y:map)empty \<Rightarrow> (x,y)dom_fun_to_map

 MapGA.it_map_restrict@map_restrict: (x:map)iterate (x:map)empty (x:map)update_dj \<Rightarrow> (x,x)restrict
 MapGA.it_map_value_image_filter@map_value_image_filter: (x:map)iterate (x:map)empty (x:map)update_dj \<Rightarrow> (x,x)map_value_image_filter
 MapGA.it_map_image_filter@map_image_filter: (x:map)iterate (x:map)empty (x:map)update_dj \<Rightarrow> (x,x)map_image_filter

 MapGA.eu_sng@map_sng: (x:map)empty (x)update \<Rightarrow> (x)sng
 MapGA.it_size@map_size: (x:map)iterate \<Rightarrow> (x)size
 MapGA.iti_size_abort@map_size_abort: (x:map)iteratei \<Rightarrow> (x)size_abort
 MapGA.sza_isSng@map_isSng: (x:map)size_abort \<Rightarrow> (x)isSng
