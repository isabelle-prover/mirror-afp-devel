...
syntax
  "_inprod_cvec" :: "complex_vec \<Rightarrow> complex_vec \<Rightarrow> complex"  (\<open>\<langle>_,_\<rangle>\<close>)
syntax_consts
...
syntax
  "_norm_cvec" :: "complex_vec \<Rightarrow> complex"  (\<open>\<langle>_\<rangle>\<close>)
syntax_consts
