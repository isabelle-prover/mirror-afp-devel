header{* Examples of Pseudo-Hoops *}
...
typedef (open) 'a G = "G::'a::lgroup_with_const set"
proof
...
typedef (open) ('a::lgroup) N = "N :: 'a::lgroup set"
proof
...
typedef (open) ('a, 'b) OrdSum = "OrdSum :: ('a::pseudo_hoop_algebra \<times> 'b::pseudo_hoop_algebra) set"
proof
