...
next
  ...
  with V_in_ParamUses that show ?thesis
    using [[simproc del: list_to_set_comprehension]] by (cases nt, auto) (case_tac "instrs_of (PROG P) C M ! a", simp_all, fastsimp)
qed
...
proof -
  ...
  ultimately show ?thesis using
    ...
    by (fastsimp dest: visible_method_exists map_of_SomeD distinct_fst_isin_same_fst
...
next
  ...
  next
    ...
    with params have "PROG P \<turnstile> D sees M': Ts\<rightarrow>T=(mxs, mxl0, is, xt) in D"
      ...
      by (fastsimp elim: in_set_procsE dest: sees_method_fun)+
    ultimately show ?thesis using CFG_Invoke_Call
      by (fastsimp dest: sees_method_fun list_all2_lengthD simp: min_def)
  qed simp_all
next
  fix a
  assume "valid_edge (P, C0, Main) a"
...
next
  ...
  then obtain ek n'
    ...
    by (fastsimp simp: JVMCFG_Interpret.valid_node_def)
  ...
  proof
    ...
    next
      case CFG_Invoke_Return_Check_Normal with V show ?thesis
        by (fastsimp intro: Def_Invoke_Return_Heap
  ...
  next
    ...
    next
      case CFG_Return_from_Method with V show ?thesis
        by (fastsimp elim!: JVMCFG.cases intro!: Def_Main_Stack_0
...
next
  ...
  from params V obtain D fs ms Ts T mb where "class (PROG P) (fst p) = \<lfloor>(D, fs, ms)\<rfloor>"
    ...
    by (cases p) (fastsimp elim: in_set_procsE)
  ...
  proof cases
    ...
    from Main_Call ins V show ?thesis
      by (fastsimp intro!: Def_Invoke_Call_Heap Def_Invoke_Call_Local
  ...
  next
    ...
    from CFG_Invoke_Call ins V show ?thesis
      by (fastsimp intro!: Def_Invoke_Call_Local Def_Invoke_Call_Heap
...
next
  ...
  from V obtain C M pc M' n'' i where
    ...
    by -(erule in_set_ParamUsesE, fastsimp+)
  from ve show "V \<in> Use P n"
  proof
    assume "valid_edge (P, C0, Main) (n, ek, n')"
    from this V show ?thesis unfolding valid_edge_def
    proof cases
      case Main_Call_LFalse with V show ?thesis by (fastsimp intro: Use_Main_Heap)
    next
      case Main_Call with V show ?thesis by (fastsimp intro: Use_Main_Heap)
    next
      case CFG_Invoke_Call with V show ?thesis
        by (fastsimp intro: Use_Normal_Heap Use_Normal_Stack [where d="Suc i"])
    next
      case CFG_Invoke_False with V show ?thesis
        by (fastsimp intro: Use_Normal_Heap Use_Normal_Stack [where d="Suc i"])
    qed simp_all
  next
    ...
    from this V show ?thesis unfolding valid_edge_def
    proof cases
      case Main_to_Call with V show ?thesis by (fastsimp intro: Use_Main_Heap)
    next
...
next
  ...
  next
    ...
    proof cases
      case CFG_Load with V_notin_Def show ?thesis by (fastsimp intro: Def_Load)
    next case CFG_Store with V_notin_Def show ?thesis by (fastsimp intro: Def_Store)
    next case CFG_Push with V_notin_Def show ?thesis by (fastsimp intro: Def_Push)
    next case CFG_IAdd with V_notin_Def show ?thesis by (fastsimp intro: Def_IAdd)
    next case CFG_CmpEq with V_notin_Def show ?thesis by (fastsimp intro: Def_CmpEq)
    next case CFG_New_Update with V_notin_Def show ?thesis
        by (fastsimp intro: Def_New_Heap Def_New_Stack)
    next case CFG_New_Exceptional_prop with V_notin_Def show ?thesis
        by (fastsimp intro: Def_Exception)
    next case CFG_New_Exceptional_handle with V_notin_Def show ?thesis
        by (fastsimp intro: Def_Exception Def_Exception_handle)
    next case CFG_Getfield_Update with V_notin_Def show ?thesis
        by (fastsimp intro: Def_Getfield split: split_split)
    ...
    next case CFG_Putfield_Update with V_notin_Def show ?thesis
        by (fastsimp intro: Def_Putfield split: split_split)
    ...
    next case CFG_Checkcast_Exceptional_handle with V_notin_Def show ?thesis
        by (fastsimp intro: Def_Exception Def_Exception_handle)
    next case CFG_Throw_prop with V_notin_Def show ?thesis by (fastsimp intro: Def_Exception)
    next case CFG_Throw_handle with V_notin_Def show ?thesis
        by (fastsimp intro: Def_Exception Def_Exception_handle)
    next case CFG_Invoke_NP_prop with V_notin_Def show ?thesis by (fastsimp intro: Def_Exception)
    ...
    next case CFG_Invoke_Return_Exceptional_handle with V_notin_Def show ?thesis
        by (fastsimp intro: Def_Exception_handle_return Def_Exception)
    next case CFG_Return with V_notin_Def show ?thesis by (fastsimp intro: Def_Return)
...
next
  ...
  next case Main_Return_to_Exit with use_Eq show ?thesis
      by (fastsimp elim: Def.cases intro: Use_Return_Heap Use_Return_Exception Use_Return_Stack)
  next case Method_LFalse with use_Eq show ?thesis
      by (fastsimp elim: Def.cases intro: Use_Method_Entry_Heap Use_Method_Entry_Local) 
  next case Method_LTrue with use_Eq show ?thesis
      by (fastsimp elim: Def.cases intro: Use_Method_Entry_Heap Use_Method_Entry_Local)
  next case CFG_Load with use_Eq show ?thesis
      by (fastsimp elim: Def.cases intro: Use_Enter_Local)
  next case CFG_Store with use_Eq show ?thesis
      by (fastsimp elim: Def.cases intro: Use_Enter_Stack)
  next case (CFG_IAdd C M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      ...
      by (fastsimp intro: Use_Enter_Stack)+
  ...
  next case CFG_New_Update
    hence "Heap \<in> Use P (sourcenode a)" by (fastsimp intro: Use_Normal_Heap)
    with use_Eq CFG_New_Update show ?thesis by (fastsimp elim: Def.cases)
  next case (CFG_Getfield_Update C  M pc)
    hence "Heap \<in> Use P (sourcenode a)"
      and "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Normal_Heap Use_Normal_Stack)+
  ...
  next case (CFG_Throw_prop C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Exceptional_Stack)
    with use_Eq CFG_Throw_prop show ?thesis by (fastsimp elim: Def.cases)
  next case (CFG_Throw_handle C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Exceptional_Stack)
    with use_Eq CFG_Throw_handle show ?thesis by (fastsimp elim: Def.cases)
  ...
  next case CFG_Invoke_Return_Exceptional_handle with use_Eq show ?thesis
      by (fastsimp elim: Def.cases intro: Use_Exceptional_Exception)
...
next
  ...
  next case (CFG_IfFalse_False C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with use_Eq CFG_IfFalse_False pred show ?thesis by fastsimp
  next case (CFG_IfFalse_True C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with pred use_Eq CFG_IfFalse_True show ?thesis by fastsimp
  next case CFG_New_Check_Normal
    hence "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Heap)
    with pred use_Eq CFG_New_Check_Normal show ?thesis by fastsimp
  next case CFG_New_Check_Exceptional 
    hence "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Heap)
    with pred use_Eq CFG_New_Check_Exceptional show ?thesis by fastsimp
  next case (CFG_Getfield_Check_Normal C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with pred use_Eq CFG_Getfield_Check_Normal show ?thesis by fastsimp
  next case (CFG_Getfield_Check_Exceptional C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with pred use_Eq CFG_Getfield_Check_Exceptional  show ?thesis by fastsimp
  next case (CFG_Putfield_Check_Normal C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 2) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with pred use_Eq CFG_Putfield_Check_Normal show ?thesis by fastsimp
  next case (CFG_Putfield_Check_Exceptional C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 2) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with pred use_Eq CFG_Putfield_Check_Exceptional show ?thesis by fastsimp
  next case (CFG_Checkcast_Check_Normal C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      and "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack Use_Enter_Heap)+
    with pred use_Eq CFG_Checkcast_Check_Normal show ?thesis by fastsimp
  next case (CFG_Checkcast_Check_Exceptional C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      and "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack Use_Enter_Heap)+
    with pred use_Eq CFG_Checkcast_Check_Exceptional show ?thesis by fastsimp
  next case (CFG_Throw_Check C  M pc)
    hence "Stack (stkLength (P, C, M) pc - 1) \<in> Use P (sourcenode a)"
      and "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack Use_Enter_Heap)+
    with pred use_Eq CFG_Throw_Check show ?thesis by fastsimp
  next case (CFG_Invoke_Check_NP_Normal C  M pc M' n)
    hence "Stack (stkLength (P, C, M) pc - (Suc n)) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with pred use_Eq CFG_Invoke_Check_NP_Normal show ?thesis by fastsimp
  next case (CFG_Invoke_Check_NP_Exceptional C  M pc M' n)
    hence "Stack (stkLength (P, C, M) pc - (Suc n)) \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Enter_Stack)
    with pred use_Eq CFG_Invoke_Check_NP_Exceptional show ?thesis by fastsimp
  next case (CFG_Invoke_Call C  M pc M' n)
    hence "Stack (stkLength (P, C, M) pc - (Suc n)) \<in> Use P (sourcenode a)"
      and "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Normal_Heap Use_Normal_Stack)+
    with pred use_Eq CFG_Invoke_Call show ?thesis by fastsimp
  next case CFG_Invoke_Return_Check_Normal
    hence "Exception \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Return_Exception)
    with pred use_Eq CFG_Invoke_Return_Check_Normal show ?thesis by fastsimp
  next case CFG_Invoke_Return_Check_Exceptional
    hence "Exception \<in> Use P (sourcenode a)" and "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Return_Exception Use_Return_Heap)+
    with pred use_Eq CFG_Invoke_Return_Check_Exceptional show ?thesis by fastsimp
  next case CFG_Invoke_Return_Exceptional_prop
    hence "Exception \<in> Use P (sourcenode a)" and "Heap \<in> Use P (sourcenode a)"
      by (fastsimp intro: Use_Return_Exception Use_Return_Heap)+
    with pred use_Eq CFG_Invoke_Return_Exceptional_prop show ?thesis by fastsimp
...
next
  ...
  next
    ...
    moreover with `(P, C0, Main) \<turnstile> \<Rightarrow>(C, M, \<lfloor>pc\<rfloor>, Normal)` `C \<noteq> ClassMain P`
      ...
      by (fastsimp dest!: reachable_node_impl_wt_instr dest: sees_method_fun list_all2_lengthD)
...
next
  ...
  proof cases
    case Main_Call with ve_a' kind_a' src pred_s pred_s' show ?thesis unfolding valid_edge_def
      by (cases a, cases a') (fastsimp elim: JVMCFG.cases dest: sees_method_fun)
  next
    ...
    next
      case CFG_Invoke_Call with src invoke_call1 show ?thesis
        by clarsimp (cases a, cases a', fastsimp dest: sees_method_fun)
    qed simp_all
  qed simp_all
next
...
next
  ...
  thus "f' vmap vmap' = vmap'(ParamDefs P (targetnode a) [:=] map vmap outs)"
    unfolding valid_edge_def
    by (cases, simp_all) (fastsimp elim: in_set_procsE simp: fun_upd_twist)
next
  fix a a'
  { fix P n f n' e n''
    assume "P \<turnstile> n -\<Up>f\<rightarrow> n'" and "P \<turnstile> n -e\<rightarrow> n''"
    hence "e = \<Up>f \<and> n' = n''"
      by cases (simp_all, (fastsimp elim: JVMCFG.cases)+)
  }
  note upd_det = this
  { fix P n Q n' Q' n'' s
    ...
    proof cases
      case CFG_Throw_Check with edge' trg show ?thesis by cases fastsimp+
    qed (simp_all, (fastsimp elim: JVMCFG.cases)+)
  }
  note pred_det = this
  assume "valid_edge (P, C0, Main) a"
