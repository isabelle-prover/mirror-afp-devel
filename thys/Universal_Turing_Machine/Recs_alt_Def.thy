(* Title: thys/Recs_alt_Def.thy
   Author: Christian Urban
 *)

chapter \<open>An alternative modelling of Recursive Functions\<close>
...
section \<open>Some auxiliary lemmas about the Recursive Functions Sigma and Pi\<close>
...
fun rec_eval :: "recf \<Rightarrow> nat list \<Rightarrow> nat"
  ...
  | "rec_eval (Pr n f g) [] = undefined"     (* added by FABR *)
