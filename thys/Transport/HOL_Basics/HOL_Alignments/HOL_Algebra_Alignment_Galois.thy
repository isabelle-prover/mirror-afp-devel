...
context
  ...
  notes defs[simp] = L_def R_def l_def r_def
...
lemma half_galois_prop_left_right_left [HOL_Algebra_galois_alignment]: "(R \<^sub>h\<unlhd> L) r l"
  ...
  by (intro half_galois_prop_leftI; elim left_GaloisE)
  (auto elim!: rel_restrict_rightE intro!: rel_restrict_rightI; metis?)
...
lemma half_galois_prop_right_right_left [HOL_Algebra_galois_alignment]: "(R \<unlhd>\<^sub>h L) r l"
  ...
  by (intro half_galois_prop_rightI; elim Galois_rightE)
  (fastforce intro!: rel_restrict_rightI)
