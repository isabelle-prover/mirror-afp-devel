...
theory Transport_Functions_Galois_Connection
  imports
    ...
    Transport_Functions_Mono_Conditions
begin
...
lemma galois_connection_left_right_if_galois_connection_mono_2_assms_leftI:
  ...
  and mono_l2_2: "((x' : in_codom (\<le>\<^bsub>R1\<^esub>)) \<Rightarrow> (x1 x2 \<Colon> (\<le>\<^bsub>L1\<^esub>) | x2 \<^bsub>L1\<^esub>\<lessapprox> x') \<Rightarrow>
...
lemma galois_connection_left_right_if_galois_connection_mono_assms_leftI:
  ...
  and "((x' : in_codom (\<le>\<^bsub>R1\<^esub>)) \<Rightarrow> (x1 x2 \<Colon> (\<le>\<^bsub>L1\<^esub>) | x2 \<^bsub>L1\<^esub>\<lessapprox> x') \<Rightarrow>
    (in_field (\<le>\<^bsub>L2 x1 (r1 x')\<^esub>)) \<Rrightarrow> (\<le>\<^bsub>R2 (l1 x1) x'\<^esub>)) l2"
proof -
  ...
  proof -
    ...
    with mono_l2 show ?thesis using \<open>x1' \<le>\<^bsub>R1\<^esub> x2'\<close> R2_le1 by fastforce
  qed
qed (use mono_l2 refl_R1 in blast)
...
lemma galois_connection_left_right_if_galois_connection_mono_2_assms_rightI:
  ...
  and mono_r2: "((x : in_dom (\<le>\<^bsub>L1\<^esub>)) \<Rightarrow> (x1' x2' \<Colon> (\<le>\<^bsub>R1\<^esub>) | x \<^bsub>L1\<^esub>\<lessapprox> x1') \<Rightarrow>
...
proof -
  ...
  proof -
    ...
    with mono_r2 show ?thesis using L2_le2 \<open>x1 \<le>\<^bsub>L1\<^esub> x2\<close> by (auto 12 0)
  qed
...
lemma galois_connection_left_right_if_galois_connection_mono_assms_rightI:
  ...
  and "((x : in_dom (\<le>\<^bsub>L1\<^esub>)) \<Rightarrow> (x1' x2' \<Colon> (\<le>\<^bsub>R1\<^esub>) | x \<^bsub>L1\<^esub>\<lessapprox> x1') \<Rightarrow>
    (in_field (\<le>\<^bsub>R2 (l1 x) x2'\<^esub>)) \<Rrightarrow> (\<le>\<^bsub>L2 x (r1 x2')\<^esub>)) r2"
proof -
  ...
  qed
qed (use mono_r2 refl_L1 in blast)
...
lemma galois_connection_left_rightI':
  ...
  and "\<And>x1' x2'. x1' \<le>\<^bsub>R1\<^esub> x2' \<Longrightarrow>
    ((\<le>\<^bsub>L2 (r1 x1') (r1 x2')\<^esub>) \<Rightarrow> (\<le>\<^bsub>R2 (\<epsilon>\<^sub>1 x1') x2'\<^esub>)) (l2\<^bsub>x2' (r1 x1')\<^esub>)"
  and "\<And>x1 x2. x1 \<le>\<^bsub>L1\<^esub> x2 \<Longrightarrow> ((\<le>\<^bsub>R2 (l1 x1) (l1 x2)\<^esub>) \<Rightarrow> (\<le>\<^bsub>L2 x1 (\<eta>\<^sub>1 x2)\<^esub>)) (r2\<^bsub>x1 (l1 x2)\<^esub>)"
  and "\<And>x x'. x \<^bsub>L1\<^esub>\<lessapprox> x' \<Longrightarrow> ((\<le>\<^bsub>L2 x (r1 x')\<^esub>) \<unlhd> (\<le>\<^bsub>R2 (l1 x) x'\<^esub>)) (l2\<^bsub>x' x\<^esub>) (r2\<^bsub>x x'\<^esub>)"
  and "\<And>x1 x2. x1 \<le>\<^bsub>L1\<^esub> x2 \<Longrightarrow> (\<le>\<^bsub>L2 x2 x2\<^esub>) \<le> (\<le>\<^bsub>L2 x1 x2\<^esub>)"
...
lemma galois_connection_left_rightI:
  ...
  (auto 8 0 dest!: tdfrs.t1.right_left_Galois_if_right_relI)
