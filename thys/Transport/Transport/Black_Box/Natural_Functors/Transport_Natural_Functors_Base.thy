...
axiomatization
  ...
  and Fset1_natural: "\<And>f1 f2 f3. Fset1 \<circ> Fmap f1 f2 f3 = Set.image f1 \<circ> Fset1"
  and Fset2_natural: "\<And>f1 f2 f3. Fset2 \<circ> Fmap f1 f2 f3 = Set.image f2 \<circ> Fset2"
  and Fset3_natural: "\<And>f1 f2 f3. Fset3 \<circ> Fmap f1 f2 f3 = Set.image f3 \<circ> Fset3"
...
notation L3 (infix \<open>\<le>\<^bsub>L3\<^esub>\<close> 50)
notation R3 (infix \<open>\<le>\<^bsub>R3\<^esub>\<close> 50)
...
notation t3.ge_left (infix \<open>\<ge>\<^bsub>L3\<^esub>\<close> 50)
notation t3.ge_right (infix \<open>\<ge>\<^bsub>R3\<^esub>\<close> 50)
...
notation t3.left_Galois (infix \<open>\<^bsub>L3\<^esub>\<lessapprox>\<close> 50)
notation t3.right_Galois (infix \<open>\<^bsub>R3\<^esub>\<lessapprox>\<close> 50)
...
notation t3.ge_Galois_left (infix \<open>\<greaterapprox>\<^bsub>L3\<^esub>\<close> 50)
notation t3.ge_Galois_right (infix \<open>\<greaterapprox>\<^bsub>R3\<^esub>\<close> 50)
...
notation t3.right_ge_Galois (infix \<open>\<^bsub>R3\<^esub>\<greaterapprox>\<close> 50)
notation t3.Galois_right (infix \<open>\<lessapprox>\<^bsub>R3\<^esub>\<close> 50)
...
notation t3.left_ge_Galois (infix \<open>\<^bsub>L3\<^esub>\<greaterapprox>\<close> 50)
notation t3.Galois_left (infix \<open>\<lessapprox>\<^bsub>L3\<^esub>\<close> 50)
...
notation t3.unit (\<open>\<eta>\<^sub>3\<close>)
notation t3.counit (\<open>\<epsilon>\<^sub>3\<close>)
