...
See for instance \<^cite>\<open>ChoKa97\<close> for an introduction to Combinatorics on Words, and \<^cite>\<open>"Lo83" and "Lo2" and "Lo3"\<close> as another reference for Combinatorics on Words.
