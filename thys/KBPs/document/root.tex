...
% FIXME sane default for proof documents
\parindent 0pt
\parskip 0.5ex
...
\title{\titl}%
\author{Peter Gammie\inst{1,2}}
\institute{The Australian National University, Canberra ACT 0200, Australia\\
  \email{Peter.Gammie@anu.edu.au} \\WWW home page:
  \url{http://peteg.org/} \and National ICT Australia}
\maketitle
...
% FIXME DBLP:journals/dc/FaginHMV97, ??
