...
(* Subsumed by theory \<open>Finiteness\<close>, could go *)

section\<open>Finiteness Test for CFGs in CNF\<close>

theory Finiteness_CNF
...
lemma is_infinite_check:
  ...
  unfolding is_infinite_def is_reachable_step_def by (auto simp: pre_star_iff)
