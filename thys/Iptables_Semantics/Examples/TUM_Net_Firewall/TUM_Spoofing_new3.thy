  ...
  *)
  ...
  lemma "spoofing_protection (preprocess net_fw_2_FORWARD_default_policy net_fw_2) =
   [(''eth1.96'',   True),
    (''eth1.108'',  True),
    (''eth1.109'',  True),
    (''eth1.110'',  False), \<comment> \<open>INET\<close>
    (''eth1.116'',  True),
    (''eth1.152'',  True),
    (''eth1.171'',  True),
    (''eth1.173'',  True),
    ...
    (''eth1.1017'', True),
    (''eth1.1111'', True),
    (''eth1.97'',   False), \<comment> \<open>VLAN for internal testing, no spoofing protection\<close>
    (''eth1.1019'', True),
    (''eth1.1020'', True),
    (''eth1.1023'', True),
    (''eth1.1025'', True),
    (''eth1.1024'', False) \<comment> \<open>transfer net\<close>
   ]" by eval
  ...
  *)
  ...
  lemma "spoofing_protection (preprocess net_fw_3_FORWARD_default_policy net_fw_3) =
   [(''eth1.96'',   True),
    (''eth1.108'',  True),
    (''eth1.109'',  True),
    (''eth1.110'',  True), \<comment> \<open>INET\<close>
    (''eth1.116'',  True),
    (''eth1.152'',  True),
    (''eth1.171'',  True),
    (''eth1.173'',  True),
    ...
    (''eth1.1023'', True),
    (''eth1.1025'', True),
    (''eth1.1024'', True) \<comment> \<open>transfer net\<close>
   ]" by eval
