...
text \<open>We define elementary column operations and also combine them with elementary
  ...
  matrices into Jordan normal forms.\<close>
...
text \<open>Each column-operation can be seen as a multplication of 
...
lemma addcol_mat: assumes A: "A \<in> carrier\<^sub>m nr n" 
  and k: "k < n"
  shows "addcol (a :: 'a :: comm_ring_1) l k A = A \<otimes>\<^sub>m addrow_mat n a k l"
