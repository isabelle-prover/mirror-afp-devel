...
proof -
  ...
  proof -
    ...
    proof (rule sorted_nth_strict_mono, auto)
      show "y < length (sorted_list_of_set ?I)"
        by (metis assms atLeastLessThan_iff card_atLeastLessThan card_image diff_zero distinct_card 
            distinct_sorted_list_of_set finite_atLeastLessThan finite_imageI set_sorted_list_of_set y)
    qed (simp add: xy)
...
proof -
  ...
  have "sorted_list_of_set ?I ! i = pick ?I i"
    by (rule sorted_list_of_set_eq_pick, auto simp add: length_I i)
