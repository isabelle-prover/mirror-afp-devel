...
begin
instance 
  by standard (auto simp flip: type_definition.Abs_image [OF type_definition_fin3329])
end
...
lemma of_int_mod_ring_eq_iff [simp]:
  "(of_int_fin3329 a = of_int_fin3329 b) \<longleftrightarrow> ((a mod 3329) = (b mod 3329))"
