section \<open>Implementations of the HSI-Method\<close>
...
proof -
  ...
  show ?thesis
    unfolding * ** \<open>distFun' = distFun\<close> hsi_method_via_spy_framework_def by simp
qed
...
proof -
  ...
  show ?thesis
    unfolding * ** \<open>distFun' = distFun\<close> hsi_method_via_h_framework_def by simp
qed
