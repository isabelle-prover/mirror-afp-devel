...
proof-
  ...
  moreover have "\<bar>Val a + Val b\<bar> < threshold float_format" 
    using threshold by auto
  ...
  case True 
      ...
      then have "Val a + Val b + error (Val a + Val b) = 0" using True by (metis val_zero)
