...
section \<open>Authenticated Diffie-Hellman Protocol (L3 locale)\<close>
...
text \<open>New locale for the level 3 protocol. This locale does not add new assumptions, 
it is only used to separate the level 3 protocol from the implementation locale.\<close>
...
l3_trans :: "l3_trans"
where
  "l3_trans \<equiv> (\<Union> M X Rb Ra A B K.
     l3_step1 Ra A B \<union>
     l3_step2 Rb A B X \<union>
     l3_step3 Ra A B X \<union>
     l3_step4 Rb A B X \<union>
     l3_dy M \<union>
...
text \<open>We want to prove @{term "l3_secrecy"}, i.e.,
