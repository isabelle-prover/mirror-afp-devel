subsection\<open>GoedelVariantHOML2inS4.thy\<close>
text\<open>The same as GoedelVariantHOML2, but now in logic S4, where the proof of theorem Th3 fails.\<close>
theory GoedelVariantHOML2inS4 imports HOMLinHOLonlyS4
begin 
