subsection\<open>ScottVariantHOMLinS4.thy\<close>
text\<open>\<close>
...
theorem T3: "\<lfloor>\<^bold>\<box>(\<^bold>\<exists>\<^sup>Ex. G x)\<rfloor>" nitpick[card e=1, card i=2] oops \<comment>\<open>Countermodel found\<close>
