subsection\<open>GoedelVariantHOML3AndersonQuan.thy\<close>
text\<open>The same as GoedelVariantHOML3, but now for a mixed use of actualist and possibilist quantifiers 
for entities; cf. Footnote 20 in \cite{J75}.\<close>
theory GoedelVariantHOML3AndersonQuant imports HOMLinHOL ModalFilter
begin 
...
lemma Filter: "\<lfloor>Filter P\<rfloor>" using Ax1 Ax4 MC NegProps PosProps Rsymm Ax2a God_def Th5 by (smt (verit, ccfv_threshold))
lemma UltraFilter: "\<lfloor>UFilter P\<rfloor>" using Ax2a Filter by blast 
