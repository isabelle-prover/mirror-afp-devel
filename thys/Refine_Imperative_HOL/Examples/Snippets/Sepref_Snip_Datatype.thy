...
begin
  ...
  lemma [sepref_monadify_comb]: "case_enum$f1$f2$f3$f4$f5$x \<equiv> op \<bind>$(EVAL$x)$(\<lambda>\<^sub>2x. SP case_enum$f1$f2$f3$f4$f5$x)" by simp
  ...
  lemma [sepref_monadify_comb]: "EVAL$(case_enum$(\<lambda>\<^sub>2x. f1 x)$(\<lambda>\<^sub>2x. f2 x)$f3$(\<lambda>\<^sub>2x y. f4 x y)$(\<lambda>\<^sub>2x y. f5 x y)$x) 
    \<equiv> op \<bind>$(EVAL$x)$(\<lambda>\<^sub>2x. SP case_enum$(\<lambda>\<^sub>2x. EVAL $ f1 x)$(\<lambda>\<^sub>2x. EVAL $ f2 x)$(EVAL $ f3)$(\<lambda>\<^sub>2x y. EVAL $ f4 x y)$(\<lambda>\<^sub>2x y. EVAL $ f5 x y)$x)"
