...
text \<open>\noindent
  Dijkstra's algorithm~\<^cite>\<open>"Dijk59"\<close> is a classical algorithm to determine the shortest
  ...
  of Cormen et al.~\<^cite>\<open>"Cormen-Leiserson-Rivest"\<close>. However, for the sake of simplicity, 
