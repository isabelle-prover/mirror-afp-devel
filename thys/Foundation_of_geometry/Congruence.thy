...
Also, the uniqueness of the large and small relationship between the two angles and the transitive relation of three or more those have not been proved in @{cite "Hilbert"}.
...
As a result, the proof process of Theorem 24 is different from @{cite "Hilbert"}.
\<close>
