...
constdefs excessTCount :: "nat \<Rightarrow> nat" (*<*) ("\<a>")(*>*)
...
constdefs squanderVertex :: "nat \<Rightarrow> nat \<Rightarrow> nat"  (*<*)("\<b>")(*>*)
...
constdefs scoreFace :: "nat \<Rightarrow> int" (*<*)("\<c>")(*>*)
...
constdefs squanderFace :: "nat \<Rightarrow> nat" (*<*)("\<d>")(*>*)
...
constdefs separated\<^isub>1 :: "graph \<Rightarrow> vertex set \<Rightarrow> bool"
 "separated\<^isub>1 g V \<equiv> \<forall>v \<in> V. except g v \<noteq> 0" 

text {*  2. No two vertices in V are adjacent: *}

constdefs separated\<^isub>2 :: "graph \<Rightarrow> vertex set \<Rightarrow> bool"
...
constdefs separated\<^isub>3 :: "graph \<Rightarrow> vertex set \<Rightarrow> bool"
...
constdefs separated\<^isub>4 :: "graph \<Rightarrow> vertex set \<Rightarrow> bool"
...
constdefs admissible\<^isub>1 :: "(face \<Rightarrow> nat) \<Rightarrow> graph \<Rightarrow> bool"  
...
constdefs admissible\<^isub>2 :: "(face \<Rightarrow> nat) \<Rightarrow> graph \<Rightarrow> bool"  
...
constdefs admissible\<^isub>3 :: "(face \<Rightarrow> nat) \<Rightarrow> graph \<Rightarrow> bool"  
...
constdefs tame\<^isub>1 :: "graph \<Rightarrow> bool"
...
constdefs
 is_cycle :: "graph \<Rightarrow> vertex list \<Rightarrow> bool"
"is_cycle g vs \<equiv> hd vs \<in> set(neighbors g (last vs)) \<and> is_path g vs"

constdefs tame\<^isub>2 :: "graph \<Rightarrow> bool"
 "tame\<^isub>2 g \<equiv> 
...
constdefs tameConf\<^isub>1:: "vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex list list"
 "tameConf\<^isub>1 a b c d \<equiv> [[a,b,c,d]]"

constdefs tameConf\<^isub>2:: "vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex list list"
 "tameConf\<^isub>2 a b c d \<equiv> [[a,b,c], [a,c,d]]"

constdefs tameConf\<^isub>3 :: "vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex list list"
 "tameConf\<^isub>3 a b c d e \<equiv>  [[a,b,e], [b,c,e], [a,e,c,d]]"

constdefs tameConf\<^isub>4 :: "vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex list list"
...
constdefs tame_quad :: "graph \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> vertex \<Rightarrow> bool"
...
constdefs tame\<^isub>3 :: "graph \<Rightarrow> bool"
...
constdefs tame\<^isub>4\<^isub>5 :: "graph \<Rightarrow> bool"
...
constdefs tame\<^isub>5 :: "graph \<Rightarrow> bool" 
...
constdefs tame\<^isub>6 :: "graph \<Rightarrow> bool"
...
constdefs tame\<^isub>7 :: "graph \<Rightarrow> bool"
...
constdefs tame\<^isub>8 :: "graph \<Rightarrow> bool"
