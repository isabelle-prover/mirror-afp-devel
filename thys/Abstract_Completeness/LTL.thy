...
theory LTL
imports "~~/src/HOL/Datatype_Examples/Stream" "~~/src/HOL/Library/Prefix_Order"
begin
...
proof-
  ...
  hence "xl \<le> yl \<or> yl \<le> xl" using shift_prefix_cases by auto
  thus ?thesis proof
    assume "xl \<le> yl"
