...
The type of \emph{finite timed streams} will be used %in this case 
...
\end{itemize*}
%
All the operators defined in the presented theories are based on the standard Isabelle/HOL library and  the theory \ist{Filter.thy} (see \cite{filter_thy}).
