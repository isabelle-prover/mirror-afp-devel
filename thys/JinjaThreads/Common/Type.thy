...
lemma synth_method_names_neq_aux:
  ...
  "start \<noteq> interrupted" "start \<noteq> yield"
  ...
  "notify \<noteq> interrupted" "notify \<noteq> yield"
  ...
  "join \<noteq> interrupted" "join \<noteq> yield"
  ...
  "isInterrupted \<noteq> interrupted" "isInterrupted \<noteq> yield"
  "hashcode \<noteq> clone" "hashcode \<noteq> print" "hashcode \<noteq> currentThread" 
  "hashcode \<noteq> interrupted" "hashcode \<noteq> yield"
  "clone \<noteq> print" "clone \<noteq> currentThread" 
  "clone \<noteq> interrupted" "clone \<noteq> yield"
  "print \<noteq> currentThread" 
  "print \<noteq> interrupted" "print \<noteq> yield"
  "currentThread \<noteq> interrupted" "currentThread \<noteq> yield"
