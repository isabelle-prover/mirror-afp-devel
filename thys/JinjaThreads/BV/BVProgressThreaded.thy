...
proof -
  ...
  proof -
    ...
    with `typeof_addr h (thread_id2addr a) = \<lfloor>Class_type D\<rfloor>`
  ...
  qed
  moreover from `typeof_addr h (thread_id2addr a) = \<lfloor>Class_type D\<rfloor>` `P \<turnstile> D \<preceq>\<^sup>* Thread`
