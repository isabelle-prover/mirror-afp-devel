...
proof(induct arbitrary: e' h' xs' Env T Env' T' and es' h' xs' Env Ts Env' Ts' rule: bisim1_bisims1_inducts_split)
  ...
  proof(cases)
    ...
    note [simp] = `e' = E'\<bullet>M'(ps)`
      and red = `P \<turnstile>1 \<langle>obj',(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
  ...
  next
    ...
    note [simp] = `obj' = Val v` `e' = Val v\<bullet>M'(es)`
      and red = `P \<turnstile>1 \<langle>ps, (h, xs)\<rangle> [-ta\<rightarrow>] \<langle>es, (h', xs')\<rangle>`
	...
	and e: "sim_moves ps es P ps h ([], xs, 0, None) (stk'', loc'', pc'', xcp'')" by auto
      from e have "sim_move (obj'\<bullet>M'(ps)) (obj'\<bullet>M'(es)) P (obj\<bullet>M'(ps)) h ([] @ [v], xs, length (compE2 obj) + 0, None) (stk'' @ [v], loc'', length (compE2 obj) + pc'', xcp'')"
  ...
  next
    ...
    proof
      ...
      have "P, obj\<bullet>M'(ps), n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> (stk, loc, pc, \<lfloor>a\<rfloor>)"
	...
	and bisim': "P, obj, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)" and [simp]: "xs = loc"
	by(auto dest: bisim1_Throw_\<tau>Exec_mover)
      hence "\<tau>Exec_mover_a P (obj\<bullet>M'(ps)) h (stk, loc, pc, None) ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
	by-(rule Call_\<tau>ExecrI1)
      moreover from bisim' `bsoks ps n`
      have "P, obj\<bullet>M'(ps), n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
  ...
  next
    ...
    next
      case Cons 
      with bisims1_refl[of "map Val vs" n P "hp (h, xs)" loc, simplified bsoks_def, simplified] show ?thesis
    ...
    hence "P,obj\<bullet>M'(map Val vs),n,hp (h, xs) \<turnstile> (THROW NullPointer, loc) \<leftrightarrow> ((rev vs @ [Null]), loc, length (compE2 obj) + length (compEs2 (map Val vs)), \<lfloor>addr_of_sys_xcpt NullPointer\<rfloor>)"
...
next
  ...
  next
    ...
    hence "exec_meth_a (compP2 P) [New C'] [] h ([], xs, 0, None) \<epsilon> h ([], xs, 0, \<lfloor>addr_of_sys_xcpt OutOfMemory\<rfloor>)"
      and [simp]: "ta = \<epsilon>" "h' = h" "xs' = xs" "e' = THROW OutOfMemory"
      by(auto intro!:exec_instr simp add: blank_def compP2_def simp del: fun_upd_apply)
...
next
  ...
  proof cases
    ...
    hence [simp]: "e' = newA U\<lfloor>ee'\<rceil>"
  ...
  next
    case (Red1NewArray a i)
    note [simp] = `e = Val (Intg i)` `ta = \<epsilon>` `e' = addr a` `xs' = xs`
      `h' = h(a \<mapsto> Arr U (replicate (nat i) (default_val U)))`
  ...
  next
    ...
    note [simp] = `e = Val (Intg i)` `e' = THROW NegativeArraySize`
      `h' = h` `xs' = xs` `ta = \<epsilon>`
  ...
  next
    ...
    note [simp] = `e = Val (Intg i)` `e' = THROW OutOfMemory` `h' = h` `xs' = xs` `ta = \<epsilon>`
    have "\<not> \<tau>move1 P h (newA U\<lfloor>Val (Intg i)\<rceil>)" by(auto simp add: \<tau>move1_\<tau>moves1.simps)
    moreover from bisim have s: "xcp = None" "xs = loc"
      and "\<tau>Exec_mover_a P E h (stk, loc, pc, xcp) ([Intg i], loc, length (compE2 E), None)"
      by(auto dest: bisim1Val2D1)
  ...
  next
	...
	by-(rule NewArray_\<tau>ExecrI)
      moreover from bisim' have "P, newA U\<lfloor>E\<rceil>, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = Cast U ee'`
      and red = `P \<turnstile>1 \<langle>e,(h, xs)\<rangle> -ta\<rightarrow> \<langle>ee', (h', xs')\<rangle>`
  ...
  next
    case (Red1Cast c U')
    note [simp] = `e = Val c` `ta = \<epsilon>` `e' = Val c` `h' = h` `xs' = xs`
      and type = `typeof\<^bsub>hp (h, xs)\<^esub> c = \<lfloor>U'\<rfloor>` `P \<turnstile> U' \<le> U`
    from bisim have s: "xcp = None" "xs = loc" by(auto dest: bisim_Val_loc_eq_xcp_None)
  ...
  next
	...
	by-(rule Cast_\<tau>ExecrI)
      moreover from bisim' have "P, Cast U E, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = E' \<guillemotleft>bop\<guillemotright> e2`
      and red = `P \<turnstile>1 \<langle>e1',(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
  ...
  next
    ...
    note [simp] = `e1' = Val v` `e' = Val v \<guillemotleft>bop\<guillemotright> E'`
      and red = `P \<turnstile>1 \<langle>e2,(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
    ...
    from bisim1 have s: "xcp = None" "xs = loc"
      and exec1: "\<tau>Exec_mover_a P (e1\<guillemotleft>bop\<guillemotright>e2) h (stk, loc, pc, None) ([v], xs, length (compE2 e1), None)"
  ...
  next
    ...
    have "P, e1 \<guillemotleft>bop\<guillemotright> Val v2, n, hp (h, xs) \<turnstile> (Val v, loc) \<leftrightarrow> ([v], loc, length (compE2 (e1 \<guillemotleft>bop\<guillemotright> Val v2)), None)"
      by-(rule bisim1Val2,auto)
  ...
  next
    ...
    proof
      ...
      have "P, e1\<guillemotleft>bop\<guillemotright>e2, n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> (stk, loc, pc, xcp)"
	...
	and bisim': "P, e1, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
	and [simp]: "xs = loc"
	by(auto dest: bisim1_Throw_\<tau>Exec_mover)
	...
	by-(rule BinOp_\<tau>ExecrI1)
      ...
      have "P, e1\<guillemotleft>bop\<guillemotright>e2, n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
...
next
  ...
  proof cases
    ...
    have "?exec ta (e1\<guillemotleft>bop\<guillemotright>e2) (Val v1\<guillemotleft>bop\<guillemotright>e2') (Val v1\<guillemotleft>bop\<guillemotright>E') h (stk @ [v1]) loc (length (compE2 e1) + pc) xcp h' (length (compE2 e1) + pc'') (stk'' @ [v1]) loc'' xcp''"
      using exec' \<tau>
  ...
  next
    ...
    note [simp] = `e2' = Val v2` `ta = \<epsilon>` `e' = Val v` `h' = h` `xs' = xs`
      and binop = `binop bop v1 v2 = \<lfloor>v\<rfloor>`
    have \<tau>: "\<tau>move1 P h (Val v1 \<guillemotleft>bop\<guillemotright> Val v2)" by(rule \<tau>move1BinOp)
    from bisim2 have s: "xcp = None" "lcl (h, xs) = loc" 
    ...
    have "P, e1 \<guillemotleft>bop\<guillemotright> e2, n, hp (h, xs) \<turnstile> (Val v, loc) \<leftrightarrow> ([v], loc, length (compE2 (e1 \<guillemotleft>bop\<guillemotright> e2)), None)"
      by-(rule bisim1Val2, auto)
    ultimately show ?thesis using s \<tau> by(fastsimp)
  next
    case (Bin1OpThrow2 a)
    ...
    proof
      ...
      have "P, e1\<guillemotleft>bop\<guillemotright>e2, n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> (stk @ [v1], loc, length (compE2 e1) + pc, xcp)"
	...
	and bisim': "P, e2, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)" and [simp]: "xs = loc"
	by(auto dest: bisim1_Throw_\<tau>Exec_mover)
	...
	by-(rule BinOp_\<tau>ExecrI2)
      ...
      have "P, e1\<guillemotleft>bop\<guillemotright>e2, n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> ([Addr a]@[v1], loc, length (compE2 e1) + pc', \<lfloor>a\<rfloor>)"
...
next
  ...
  next
    ...
    next
      ...
      with bisim obtain pc'
	where "\<tau>Exec_mover_a P E h (stk, loc, pc, None) ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
	and bisim': "P, E, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)" and [simp]: "xs = loc"
	by(auto dest: bisim1_Throw_\<tau>Exec_mover)
      hence "\<tau>Exec_mover_a P (V:=E) h (stk, loc, pc, None) ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
	by-(rule LAss_\<tau>ExecrI)
      moreover from bisim' have "P, V:=E, n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
...
next 
  ...
  proof cases
    ...
    note [simp] = `e' = E'\<lfloor>i\<rceil>`
      and red = `P \<turnstile>1 \<langle>a',(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
  ...
  next
    ...
    note [simp] = `a' = Val v` `e' = Val v\<lfloor>E'\<rceil>`
      and red = `P \<turnstile>1 \<langle>i,(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
  ...
  next
    case (Red1AAcc A U el I)
    hence [simp]: "a' = addr A" "e' = Val (el ! nat I)" "i = Val (Intg I)" "ta = \<epsilon>" "h' = h" "xs' = xs"
  ...
  next
    ...
    proof
      ...
      have "P, a\<lfloor>i\<rceil>, n, hp (h, xs) \<turnstile> (Throw A, xs) \<leftrightarrow> (stk, loc, pc, xcp)"
	by(auto intro: bisim1_bisims1.intros)
      thus ?thesis using \<tau> by(fastsimp)
    next
      assume [simp]: "xcp = None"
...
next
  ...
  proof cases
    ...
    have "?exec ta (a\<lfloor>i\<rceil>) (Val v1\<lfloor>i'\<rceil>) (Val v1\<lfloor>E'\<rceil>) h (stk @ [v1]) loc (length (compE2 a) + pc) xcp h' (length (compE2 a) + pc'') (stk'' @ [v1]) loc'' xcp''"
      using exec' \<tau>
  ...
  next
    case (Red1AAcc A U el I)
    hence [simp]: "v1 = Addr A" "e' = Val (el ! nat I)" "i' = Val (Intg I)" "ta = \<epsilon>" "h' = h" "xs' = xs"
      and hA: "h A = \<lfloor>Arr U el\<rfloor>" and I: "0 \<le> I" "I < int (length el)" by auto
    have \<tau>: "\<not> \<tau>move1 P h (addr A\<lfloor>Val (Intg I)\<rceil>)" by(auto simp add: \<tau>move1_\<tau>moves1.simps)
...
next
  ...
  next
    ...
    note [simp] = `i = Val v'` `a' = Val v` `e' = Val v\<lfloor>Val v'\<rceil> := E'`
      and red = `P \<turnstile>1 \<langle>e,(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
  ...
  next
    case (Red1AAss A U el I v U')
    hence [simp]: "a' = addr A" "e' = unit" "i = Val (Intg I)" "ta = \<epsilon>" "xs' = xs" "e = Val v"
  ...
  next
    ...
    ultimately show ?thesis using s \<tau> by auto blast
  next
    case (Red1AAssBounds A U el I v)
    ...
    ultimately show ?thesis using s \<tau> by auto blast
  next
    case (Red1AAssStore A U el I v U')
  ...
  next
    ...
    proof
      ...
      have "P, a\<lfloor>i\<rceil> := e, n, hp (h, sx) \<turnstile> (Throw A, xs) \<leftrightarrow> (stk, loc, pc, xcp)"
	by(auto intro: bisim1_bisims1.intros)
      thus ?thesis using \<tau> by(fastsimp)
    next
      assume [simp]: "xcp = None"
...
next
  ...
  next
    ...
    note [simp] = `i' = Val v'` `e' = Val v1\<lfloor>Val v'\<rceil> := E'`
      and red = `P \<turnstile>1 \<langle>e,(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
    from red have \<tau>: "\<tau>move1 P h (Val v1\<lfloor>Val v'\<rceil> := e) = \<tau>move1 P h e" by(auto simp add: \<tau>move1_\<tau>moves1.simps)
    from bisim2 have s: "xcp = None" "xs = loc"
      and "\<tau>Exec_mover_a P i h (stk, loc, pc, xcp) ([v'], xs, length (compE2 i), None)"
      by(auto dest: bisim1Val2D1)
    hence "\<tau>Exec_mover_a P (a\<lfloor>i\<rceil> := e) h (stk @ [v1], loc, length (compE2 a) + pc, xcp) ([v'] @ [v1], xs, length (compE2 a) + length (compE2 i), None)"
      by-(rule AAss_\<tau>ExecrI2)
    ...
    proof(cases "\<tau>move1 P h (Val v1\<lfloor>Val v'\<rceil> := e)")
      case True
      with exec' \<tau> have [simp]: "h = h'" and e: "sim_move e E' P e h ([], xs, 0, None) (stk'', loc'', pc'', xcp'')" by auto
      from e have "sim_move (Val v1\<lfloor>Val v'\<rceil> := e) (Val v1\<lfloor>Val v'\<rceil> := E') P (a\<lfloor>i\<rceil> := e) h ([] @ [v', v1], xs, length (compE2 a) + length (compE2 i) + 0, None) (stk'' @ [v', v1], loc'', length (compE2 a) + length (compE2 i) + pc'', xcp'')"
	by(fastsimp dest: AAss_\<tau>ExectI3 AAss_\<tau>ExecrI3 simp del: compE2_compEs2.simps)
      with True show ?thesis by auto
    next
      case False
	...
	and e': "exec_move_a P e h (stk', loc', pc', xcp') (extTA2JVM (compP2 P) ta) h' (stk'', loc'', pc'', xcp'')"
	and \<tau>': "\<not> \<tau>move2 (compP2 P) h stk' e pc' xcp'" by auto
      from e have "\<tau>Exec_mover_a P (a\<lfloor>i\<rceil> := e) h ([] @ [v', v1], xs, length (compE2 a) + length (compE2 i) + 0, None) (stk' @ [v', v1], loc', length (compE2 a) + length (compE2 i) + pc', xcp')" by(rule AAss_\<tau>ExecrI3)
      moreover from e' have "exec_move_a P (a\<lfloor>i\<rceil> := e) h (stk' @ [v', v1], loc', length (compE2 a) + length (compE2 i) + pc', xcp') (extTA2JVM (compP2 P) ta) h' (stk'' @ [v', v1], loc'', length (compE2 a) + length (compE2 i) + pc'', xcp'')"
	by(rule exec_move_AAssI3)
  ...
  next
    case (Red1AAss A U el I v U')
    note [simp] = `v1 = Addr A` `e' = unit` `i' = Val (Intg I)` `ta = \<epsilon>` `xs' = xs` `e = Val v`
      and hA = `h A = \<lfloor>Arr U el\<rfloor>` and I = `0 \<le> I` `I < int (length el)` and v = `typeof\<^bsub>h\<^esub> v = \<lfloor>U'\<rfloor>` `P \<turnstile> U' \<le> U`
      and h' = `h' = h(A \<mapsto> Arr U (el[nat I := v]))`
    have \<tau>: "\<not> \<tau>move1 P h (AAss (addr A) (Val (Intg I)) (Val v))" by(auto simp add: \<tau>move1_\<tau>moves1.simps)
    from bisim2 have s: "xcp = None" "xs = loc"
      and "\<tau>Exec_mover_a P i h (stk, loc, pc, xcp) ([Intg I], loc, length (compE2 i), None)"
      by(auto dest: bisim1Val2D1)
  ...
  next
    ...
    from bisim2 have s: "xcp = None" "xs = loc"
      ...
      by(auto dest: bisim1Val2D1)
    hence "\<tau>Exec_mover_a P (a\<lfloor>i\<rceil> := Throw ad) h (stk @ [v1], loc, length (compE2 a) + pc, xcp) ([vi] @ [v1], loc, length (compE2 a) + length (compE2 i), None)"
      by-(rule AAss_\<tau>ExecrI2)
    also have "\<tau>Exec_mover_a P (a\<lfloor>i\<rceil>:=Throw ad) h ([vi] @ [v1], loc, length (compE2 a) + length (compE2 i), None) ([Addr ad, vi, v1], loc, Suc (length (compE2 a) + length (compE2 i)), \<lfloor>ad\<rfloor>)"
      by(rule \<tau>Execr2step)(auto simp add: exec_move_def exec_meth_instr \<tau>move2_iff \<tau>move1_\<tau>moves1.simps)
    also have "P,a\<lfloor>i\<rceil>:=Throw ad,n,h \<turnstile> (Throw ad, loc) \<leftrightarrow> ([Addr ad] @ [vi, v1], loc, (length (compE2 a) + length (compE2 i) + length (compE2 (addr ad))), \<lfloor>ad\<rfloor>)"
      by(rule bisim1AAssThrow3[OF bisim1Throw2 `bsok a n` `bsok i n`])(simp)
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = Val v\<lfloor>Val v'\<rceil> := E'`
      and red = `P \<turnstile>1 \<langle>ee,(h, xs)\<rangle> -ta\<rightarrow> \<langle>E',(h', xs')\<rangle>`
  ...
  next
    case (Red1AAss A U el I V U')
    note [simp] = `v = Addr A` `e' = unit` `v' = Intg I` `ta = \<epsilon>` `xs' = xs` `ee = Val V`
      and hA = `h A = \<lfloor>Arr U el\<rfloor>` and I = `0 \<le> I` `I < int (length el)` and v = `typeof\<^bsub>h\<^esub> V = \<lfloor>U'\<rfloor>` `P \<turnstile> U' \<le> U`
      and h' = `h' = h(A \<mapsto> Arr U (el[nat I := V]))`
    have \<tau>: "\<not> \<tau>move1 P h (AAss (addr A) (Val (Intg I)) (Val V))" by(auto simp add: \<tau>move1_\<tau>moves1.simps)
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = ee'\<bullet>length`
      and red = `P \<turnstile>1 \<langle>a',(h, xs)\<rangle> -ta\<rightarrow> \<langle>ee', (h', xs')\<rangle>`
  ...
  next
    case (Red1ALength A U el)
    hence [simp]: "a' = addr A" "ta = \<epsilon>" "e' = Val (Intg (int (length el)))" "h' = h" "xs' = xs"
  ...
  next
	...
	by-(rule ALength_\<tau>ExecrI)
      moreover from bisim' have "P, a\<bullet>length, n, hp (h, xs) \<turnstile> (Throw A, xs) \<leftrightarrow> ([Addr A], loc, pc', \<lfloor>A\<rfloor>)"
...
next
  ...
  next
    case (Red1FAcc a C fs v)
    hence [simp]: "e = addr a" "ta = \<epsilon>" "e' = Val v" "h' = h" "xs' = xs"
  ...
  next
	...
	by-(rule FAcc_\<tau>ExecrI)
      moreover from bisim' have "P, E\<bullet>F{D}, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
...
next
  ...
  next
    case (Red1FAss a C fs v)
    note [simp] = `e1' = addr a` `e2 = Val v` `ta = \<epsilon>` `e' = unit`
  ...
  next
    ...
    proof
      ...
      have "P, e1\<bullet>F{D} := e2, n, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> (stk, loc, pc, xcp)"
	by(auto intro: bisim1_bisims1.intros)
      thus ?thesis using \<tau> by(fastsimp)
    next
      assume [simp]: "xcp = None"
  ...
  next
    ...
    note [simp] = `e1' = Val v` `e2 = Throw ad` `ta = \<epsilon>` `e' = Throw ad`
      `h' = h` `xs' = xs`
    from bisim1 have s: "xcp = None" "xs = loc"
      and "\<tau>Exec_mover_a P e1 h (stk, loc, pc, xcp) ([v], loc, length (compE2 e1), None)"
      by(auto dest: bisim1Val2D1)
...
next
  ...
  proof cases
    ...
    with exec' have "?exec ta (e1\<bullet>F{D} := e2) (Val v1\<bullet>F{D} := e2') (Val v1\<bullet>F{D} := E') h (stk @ [v1]) loc (length (compE2 e1) + pc) xcp h' (length (compE2 e1) + pc'') (stk'' @ [v1]) loc'' xcp''"
  ...
  next
    case (Red1FAss a C fs v)
    note [simp] = `v1 = Addr a` `e2' = Val v` `ta = \<epsilon>` `e' = unit`
      `h' = h(a \<mapsto> Obj C (fs((F, D) \<mapsto> v)))` `xs' = xs`
      and ha = `h a = \<lfloor>Obj C fs\<rfloor>`
  ...
  next
    ...
    proof
      assume [simp]: "xcp = \<lfloor>a\<rfloor>"
      with bisim2 `bsok e1 n`
      have "P, e1\<bullet>F{D} := e2, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> (stk @ [v1], loc, length (compE2 e1) + pc, xcp)"
	...
	by-(rule FAss_\<tau>ExecrI2)
      ...
      have "P, e1\<bullet>F{D} := e2, n, h \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> ([Addr a]@[v1], loc, length (compE2 e1) + pc', \<lfloor>a\<rfloor>)"
...
next
  ...
  next
    ...
    have "lcl (h, xs) = loc \<and> xcp = None \<and> \<tau>Exec_movesr_a P ps h (stk, loc, pc, xcp) (rev vs, loc, length (compEs2 ps), None)"
    ...
    with length have "P,obj\<bullet>M'(ps),n,hp (h, xs) \<turnstile> (THROW NullPointer, loc) \<leftrightarrow> ((rev vs @ [Null]), loc, length (compE2 obj) + length (compEs2 ps), \<lfloor>addr_of_sys_xcpt NullPointer\<rfloor>)"
  ...
  next
    ...
    proof
      ...
      have "P,obj\<bullet>M'(ps),n,hp (h, xs) \<turnstile> (Throw a, loc) \<leftrightarrow> (stk @ [v], loc, length (compE2 obj) + pc, \<lfloor>a\<rfloor>)"
	...
	by(auto dest: bisims1_Throw_\<tau>Exec_movesr)
      ...
      have "P,obj\<bullet>M'(ps),n,hp (h, xs) \<turnstile> (Throw a, loc) \<leftrightarrow> ((Addr a # rev vs) @ [v], loc, length (compE2 obj) + pc', \<lfloor>a\<rfloor>)"
	by-(rule bisim1CallThrowParams, auto)
  ...
  next
    case (Red1CallExternal a Ta vs va H')
    hence [simp]: "v = Addr a" "ps' = map Val vs"
      "e' = extRet2J va" "H' = h'" "xs' = xs"
      and Ta: "typeof\<^bsub>h\<^esub> (Addr a) = \<lfloor>Ta\<rfloor>"
      and iec: "is_external_call P Ta M'"
      and redex: "P \<turnstile> \<langle>a\<bullet>M'(vs),h\<rangle> -ta\<rightarrow>ext \<langle>va,h'\<rangle>" by auto
    ...
    obtain s: "xcp = None" "lcl (h, xs) = loc"
...
next
  ...
  next
    case (Block1Throw a)
    note [simp] = `e = Throw a` `ta = \<epsilon>` 
      `e' = Throw a` `h' = h` `xs' = xs`
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = sync\<^bsub>V\<^esub> (E1') e2`
      and red = `P \<turnstile>1 \<langle>e1', (h, xs)\<rangle> -ta\<rightarrow> \<langle>E1', (h', xs')\<rangle>`
  ...
  next
    ...
    note [simp] = `e1' = null` `e' = THROW NullPointer` `ta = \<epsilon>` `h' = h`
      `xs' = xs[V := Null]` and V = `V < length xs`
    from bisim1 have [simp]: "xcp = None" "xs = loc"
    ...
    ultimately show ?thesis by auto blast
  next
    case (Lock1Synchronized a arrobj)
    note [simp] = `e1' = addr a` `ta = \<epsilon>\<lbrace>\<^bsub>l\<^esub>Lock\<rightarrow>a\<rbrace>\<lbrace>\<^bsub>o\<^esub>Synchronization a\<rbrace>` `e' = insync\<^bsub>V\<^esub> (a) e2`
      `h' = h` `xs' = xs[V := Addr a]` and V = `V < length xs` and ha = `h a = \<lfloor>arrobj\<rfloor>`
    from bisim1 have [simp]: "xcp = None" "xs = loc"
  ...
  next
    ...
    proof
      assume [simp]: "xcp = \<lfloor>a\<rfloor>"
      with bisim1 bisim1_bsok[OF bisim2]
      have "P, sync\<^bsub>V\<^esub> (e1) e2, V, hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> (stk, loc, pc, \<lfloor>a\<rfloor>)"
	...
	and bisim': "P, e1, V, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)" and [simp]: "xs = loc"
	by(auto dest: bisim1_Throw_\<tau>Exec_mover)
...
next
  ...
  next
    case Synchronized1Null
    note [simp] = `v = Null` `e' = THROW NullPointer` `ta = \<epsilon>` `h' = h`
      `xs' = xs[V := Null]` and V = `V < length xs`
    from V
...
next
  ...
  next
    ...
    note [simp] = `e2' = Val v` `e' = Val v` `ta = \<epsilon>\<lbrace>\<^bsub>l\<^esub>Unlock\<rightarrow>a'\<rbrace>\<lbrace>\<^bsub>o\<^esub>Synchronization a'\<rbrace>` 
                  `h' = h` `xs' = xs`
  ...
  next
    ...
    note [simp] = `e2' = Throw ad` `ta = \<epsilon>\<lbrace>\<^bsub>l\<^esub>Unlock\<rightarrow>a'\<rbrace>\<lbrace>\<^bsub>o\<^esub>Synchronization a'\<rbrace>` `e' = Throw ad`
  ...
  next
    ...
    note [simp] = `e2' = Throw ad` `ta = \<epsilon>\<lbrace>\<^bsub>l\<^esub>UnlockFail\<rightarrow>a'\<rbrace>`
      `e' = THROW IllegalMonitorState` `h' = h` `xs' = xs` and xsV = `xs ! V = Addr a'` and V = `V < length xs`
    let ?pc = "6 + length (compE2 e1) + length (compE2 e2)"
    let ?stk = "Addr ad # drop (size stk - 0) stk"
    from bisim2 have [simp]: "xs = loc" by(auto dest: bisim1_ThrowD)
    from bisim2
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = Val v` `ta = \<epsilon>\<lbrace>\<^bsub>l\<^esub>Unlock\<rightarrow>a'\<rbrace>\<lbrace>\<^bsub>o\<^esub>Synchronization a'\<rbrace>` `h' = h` `xs' = xs`
      and V = `V < length xs` and xsV = `xs ! V = Addr a'`
...
next
  ...
  proof cases
    ...
    note [simp] = `ta = \<epsilon>\<lbrace>\<^bsub>l\<^esub>Unlock\<rightarrow>a'\<rbrace>\<lbrace>\<^bsub>o\<^esub>Synchronization a'\<rbrace>` `e' = Throw ad`
      `h' = h` `xs' = xs` and xsV = `xs ! V = Addr a'` and V = `V < length xs`
    let ?pc = "6 + length (compE2 e1) + length (compE2 e2)"
    from xsV V
  ...
  next
    ...
    note [simp] = `ta = \<epsilon>\<lbrace>\<^bsub>l\<^esub>UnlockFail\<rightarrow>a'\<rbrace>`
      `e' = THROW IllegalMonitorState` `h' = h` `xs' = xs` and xsV = `xs ! V = Addr a'` and V = `V < length xs`
    let ?pc = "6 + length (compE2 e1) + length (compE2 e2)"
    from xsV V
    have "\<tau>Exec_mover_a P (sync\<^bsub>V\<^esub> (e1) e2) h ([Addr ad], xs, ?pc, None) ([Addr a', Addr ad], xs, Suc ?pc, None)"
...
next
  ...
  next
    case (Red1Seq v)
    note [simp] = `e1' = Val v` `ta = \<epsilon>` `e' = e2` `h' = h` `xs' = xs`
    from bisim1 have s: "xcp = None" "lcl (h, xs) = loc"
      and "\<tau>Exec_mover_a P e1 h (stk, loc, pc, xcp) ([v], loc, length (compE2 e1), None)"
      by(auto dest: bisim1Val2D1)
    ...
    have "P, e1;; e2, n, hp (h, xs) \<turnstile> (e2, lcl (h, xs)) \<leftrightarrow> ([], loc, Suc (length (compE2 e1) + 0), None)"
  ...
  next
    ...
    next
      ...
      with bisim1 obtain pc'
	where "\<tau>Exec_mover_a P e1 h (stk, loc, pc, None) ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
	and bisim': "P, e1, n, hp (h, xs) \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)" and [simp]: "xs = loc"
	by(auto dest: bisim1_Throw_\<tau>Exec_mover)
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = if (b') e1 else e2`
      and red = `P \<turnstile>1 \<langle>e,(h, xs)\<rangle> -ta\<rightarrow> \<langle>b',(h', xs')\<rangle>`
...
next
  ...
  proof cases
    case Red1While
    note [simp] = `ta = \<epsilon>`
      `e' = if (c) (e;; while (c) e) else unit` `h' = h` `xs' = xs`
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = if (b') (e;; while (c) e) else unit`
      and red = `P \<turnstile>1 \<langle>c',(h, xs)\<rangle> -ta\<rightarrow> \<langle>b',(h', xs')\<rangle>`
  ...
  next
    case Red1CondT
    note [simp] = `c' = true` `e' = e;; while (c) e` 
      `ta = \<epsilon>` `h' = h` `xs' = xs`
    from bisim1 have s: "xcp = None" "xs = loc"
...
next
  ...
  next
	...
	where "\<tau>Exec_mover_a P E h (stk, loc, pc, None) ([Addr a], loc, pc', \<lfloor>a\<rfloor>)"
	and bisim: "P, E, n, h \<turnstile> (Throw a, xs) \<leftrightarrow> ([Addr a], loc, pc', \<lfloor>a\<rfloor>)" and s: "lcl (h, xs) = loc"
	by(auto dest: bisim1_Throw_\<tau>Exec_mover)
...
next
  ...
  next
    case (Red1TryCatch a D fs)
    note [simp] = `e = Throw a` `ta = \<epsilon>` `e' = {V:Class C'=None; e2}`
      `h' = h` `xs' = xs[V := Addr a]` and ha = `h a = \<lfloor>Obj D fs\<rfloor>` and sub = `P \<turnstile> D \<preceq>\<^sup>* C'` and V = `V < length xs`
  ...
  next
    ...
    proof
      ...
      have "P,try E catch(C' V) e2,V,hp (h, xs) \<turnstile> (Throw a, lcl (h, xs)) \<leftrightarrow> (stk, loc, pc, \<lfloor>a\<rfloor>)"
...
next
  ...
  proof cases
    ...
    note [simp] = `e' = {V:Class C'=None; E'}`
      and red = `P \<turnstile>1 \<langle>e2, (h, xs[V := Addr a])\<rangle> -ta\<rightarrow> \<langle>E', (h', xs')\<rangle>`
  ...
  next
    case (Red1Block u)
    note [simp] = `e2 = Val u` `ta = \<epsilon>` `e' = Val u`
      `h' = h` `xs' = xs[V := Addr a]`
  ...
  next
    case (Block1Throw a')
    note [simp] = `e2 = Throw a'` `h' = h` `ta = \<epsilon>`
      `e' = Throw a'` `xs' = xs[V := Addr a]`
...
next
  ...
  next
    case (Block1Throw a)
    note [simp] = `e2' = Throw a` `ta = \<epsilon>`
      `e' = Throw a` `h' = h` `xs' = xs`
...
next
  ...
  next
    case (List1Red2 ES' v)
    note [simp] = `e = Val v` `es' = Val v # ES'`
      and red = `P \<turnstile>1 \<langle>es,(h, xs)\<rangle> [-ta\<rightarrow>] \<langle>ES',(h', xs')\<rangle>`
...
proof -
  ...
  proof(cases)
    case (red1Red TA)
    note [simp] = `ta = extTA2J1 P TA`
      `exs' = exs` and red = `P \<turnstile>1 \<langle>e,(h, xs)\<rangle> -TA\<rightarrow> \<langle>e',(h, xs')\<rangle>`
    ...
    proof(cases)
      ...
      hence [simp]: "exs = EXS @ [(addr a\<bullet>M'(map Val vs), XS')]"
  ...
  next
    case (red1Call a' M' vs' C' fs' Ts' T' body' D')
    ...
    from bisim show ?thesis
    proof(cases)
      case (bl1_Normal stk loc C M pc FRS Ts T body D EXS a MM vs XS')
      hence [simp]:
        "exs = EXS @ [(addr a\<bullet>MM(map Val vs), XS')]"
        "frs = (stk, loc, C, M, pc) # FRS"
        and conf: "compP2 P,compTP P \<turnstile> (xcp, h, frs) \<surd>"
        and sees: "P \<turnstile> C sees M: Ts\<rightarrow>T = body in D"
        and bisim: "P,blocks1 0 (Class D#Ts) body,0,h \<turnstile> (e, xs) \<leftrightarrow> (stk, loc, pc, xcp)"
      ...
      from call have call': "call1 e = \<lfloor>(a', M', vs')\<rfloor>" by auto
      ...
      hence "bisim1_list1 P h (blocks1 0 (Class D'#Ts') body', xs') (((e, xs) # EXS) @ [(addr a\<bullet>MM(map Val vs), XS')]) None (?f' # ?f # FRS)"
      proof
  ...
  next
    ...
    note wt = wt_compTP_compP2[OF wf]
    from bisim have bisim: "bisim1_list1 P h (e, xs) ((E, xs') # exs') xcp frs" by simp
    thus ?thesis
    proof cases
      case (bl1_Normal stk loc C M pc FRS Ts T body D EXS a MM vs XS')
	...
	and lenxs: "max_vars e \<le> length xs" by auto
      ...
      proof(cases "EXS")
	case Nil [simp]
	with exs have [simp]: "exs' = []" "E = addr a\<bullet>MM(map Val vs)" by(simp_all)
	...
	proof(cases)
	  ...
	  hence "bisim1_list1 P h (Val v, xs') [] None []" by(rule bl1_finalVal)
	...
	next
	  ...
	  hence "bisim1_list1 P h (Throw a, xs') [] \<lfloor>a\<rfloor> []" by(rule bl1_finalThrow)
	  ultimately show ?thesis by -(rule exI conjI|assumption|simp)+
	qed
      next
	case (Cons exa exsb)
...
proof(cases)
  ...
  proof(cases)
    case (bl1_Normal stk loc C M pc FRS Ts T body D EXS a M' vs XS')
    hence [simp]:
      "exs = EXS @ [(addr a\<bullet>M'(map Val vs), XS')]"
      "frs = (stk, loc, C, M, pc) # FRS"
      and conf: "compP2 P,compTP P \<turnstile> (xcp, h, frs) \<surd>"
      and sees: "P \<turnstile> C sees M: Ts\<rightarrow>T = body in D"
      and bisim: "P,blocks1 0 (Class D#Ts) body,0,h \<turnstile> (e, xs) \<leftrightarrow> (stk, loc, pc, xcp)"
