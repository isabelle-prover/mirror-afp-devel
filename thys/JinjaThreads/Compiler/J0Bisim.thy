...
next
  ...
  note red = `P,t \<turnstile> \<langle>e,(h, Map.empty)\<rangle> -ta\<rightarrow> \<langle>e',(h', Map.empty)\<rangle>`
...
next
  ...
  from `P,t \<turnstile> \<langle>collapse (e, E # es),(h, Map.empty)\<rangle> -ta\<rightarrow> \<langle>e',(h', x')\<rangle>`
