...
where [code_unfold, monad_unfold]: "return_nondetT = return_nondet return"

definition bind_nondetT :: "('a, ('a, 'm) nondetT) bind"
where [code_unfold, monad_unfold]: "bind_nondetT = bind_nondet return bind" 

definition fail_nondetT :: "('a, 'm) nondetT fail"
where [code_unfold, monad_unfold]: "fail_nondetT = fail_nondet return"
...
where [code_unfold, monad_unfold]: "alt_nondetT = alt_nondet return bind"

definition munionMT :: "'a itself \<Rightarrow> 'm \<Rightarrow> 'm \<Rightarrow> 'm"
where "munionMT _ = munionM (return :: ('a multiset, 'm) return) bind"
...
by(simp add: bind_nondetT_def mUnionMT_def munionMT_def mUnionM_def)
...
unfolding return_nondetT_def bind_nondetT_def by(rule monad_nondetT)

lemma monad_fail_nondetT' [locale_witness]:
  "monad_commute return (bind :: ('a multiset, 'm) bind)
  \<Longrightarrow> monad_fail return (bind :: ('a, ('a, 'm) nondetT) bind) fail"
unfolding return_nondetT_def bind_nondetT_def fail_nondetT_def by(rule monad_fail_nondetT)

lemma monad_alt_nondetT' [locale_witness]: 
  "monad_commute return (bind :: ('a multiset, 'm) bind)
  \<Longrightarrow> monad_alt return (bind :: ('a, ('a, 'm) nondetT) bind) alt"
unfolding return_nondetT_def bind_nondetT_def alt_nondetT_def by(rule monad_alt_nondetT)

lemma monad_fail_alt_nondetT' [locale_witness]:
  "monad_commute return (bind :: ('a multiset, 'm) bind)
  \<Longrightarrow> monad_fail_alt return (bind :: ('a, ('a, 'm) nondetT) bind) fail alt"
unfolding return_nondetT_def bind_nondetT_def fail_nondetT_def alt_nondetT_def by(rule monad_fail_alt_nondetT)
...
unfolding return_nondetT_def bind_nondetT_def ask_nondetT_def by(rule monad_reader_nondetT)
