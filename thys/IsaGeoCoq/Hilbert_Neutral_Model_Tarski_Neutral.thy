(* IsageoCoq - Hilbert_Neutral_Model_Tarski_Neutral.thy
...
theory Hilbert_Neutral_Model_Tarski_Neutral

imports Tarski_Neutral_Hilbert

begin

section "Hilbert Neutral - Tarski Neutral Model"
...
(* End Preliminaries *)
  ...
  thus "\<And>l A B A' P::'p. A \<noteq> B \<and> A' \<noteq> P \<and> isLine l \<and> IncidentL A' l \<and> IncidentL P l \<longrightarrow>
