...
section \<open>Extensions to CryptHOL\<close>
...
text \<open>the two following lemmas are helping lemmas for Cons\_random\_list\_split\<close>
...
Intuitively: sample\_uniform\_list (k+1) = Cons (sample\_uniform) (sample\_uniform\_list k)\<close>
