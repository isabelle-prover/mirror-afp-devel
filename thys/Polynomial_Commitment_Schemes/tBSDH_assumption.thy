...
section \<open>The t-Bilinear Strong Diffie-Hellman Assumption\<close>

text\<open>The t-BSDH game and advantage as in section 2.4 of the original KZG paper
...
text \<open>The t-BSDH game states that given a t+1-long tuple in the form of $(g,g^\alpha,g^{\alpha^2},\dots,g^{\alpha^t})$
