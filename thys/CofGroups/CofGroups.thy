...
proof (rule int_induct [of "?P" 1])
  ...
  proof
    ...
    proof
      ...
      with ext_iff[of f upOne,THEN sym] 
...
next
  ...
  proof
    ...
    proof
      ...
      with ext_iff[THEN sym, of f "upOne \<circ> ?h"] 
...
next;
  ...
  proof
    ...
    proof
      ...
      with ext_iff[THEN sym, of f "inv upOne \<circ> ?h"] 
...
proof -
  ...
  proof -
    ...
    with ext_iff[THEN sym, of f id] and f_prop show "f = id" by auto;
  qed;
