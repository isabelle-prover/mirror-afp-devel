...
thus "from_nat i \<le> (GREATEST' m. \<not> is_zero_row_upt_k m (ncols (Gauss_Jordan A)) (Gauss_Jordan A))" unfolding is_zero_row_def[symmetric] by (metis leD not_leE to_nat_le)
