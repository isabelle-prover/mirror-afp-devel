...
section \<open> Copy-Pasted Material \<close>
text \<open> The next couple of lemmas are copy-pasted from Modular-arithmetic-LLL-and-HNF-algorithms
  (we copy-paste them instead of loading them to avoid excessive loading times) \<close>
context vec_module
begin

text \<open> This lemma is copy-pasted from Modular-arithmetic-LLL-and-HNF-algorithms
  (we copy-paste them instead of loading them to avoid excessive loading times) \<close>
