...
text \<open>
The following test data is taken from RFC 5903 \<^cite>\<open>"RFC5903"\<close>, \S 3.3 and \S 8.3.
The curve parameters can also be found in \S D.1.2.5 of FIPS PUB 186-4 \<^cite>\<open>"FIPS186-4"\<close>.
\<close>
