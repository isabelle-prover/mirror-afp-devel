...
ML \<open>
drop_conv @{ctyp nat} @{cterm "3::nat"} @{cterm "[1::nat, 2, 3, 4, 5, 6]"};
drop_conv @{ctyp nat} @{cterm "0::nat"} @{cterm "[1::nat, 2, 3, 4, 5, 6]"};
drop_conv @{ctyp nat} @{cterm "1::nat"} @{cterm "[1::nat, 2, 3, 4, 5, 6]"};
\<close>
...
ML \<open>
nth_conv @{ctyp nat} @{cterm "[1::nat, 2, 3, 4, 5, 6]"} @{cterm "3::nat"};
nth_conv @{ctyp nat} @{cterm "[1::nat, 2, 3, 4, 5, 6]"} @{cterm "0::nat"};
nth_conv @{ctyp nat} @{cterm "[1::nat, 2, 3, 4, 5, 6]"} @{cterm "1::nat"};
\<close>


(**** Examples ****)

ML \<open>nat_plus_conv @{cterm "123::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_plus_conv @{cterm "12345::nat"} @{cterm "67890::nat"}\<close>
ML \<open>nat_plus_conv @{cterm "12345::nat"} @{cterm "1::nat"}\<close>
ML \<open>nat_plus_conv @{cterm "1::nat"} @{cterm "12345::nat"}\<close>
ML \<open>nat_plus_conv @{cterm "1::nat"} @{cterm "1::nat"}\<close>

ML \<open>int_plus_conv @{cterm "1234::int"} @{cterm "5678::int"}\<close>
ML \<open>int_plus_conv @{cterm "-1234::int"} @{cterm "5678::int"}\<close>
ML \<open>int_plus_conv @{cterm "1234::int"} @{cterm "-5678::int"}\<close>
ML \<open>int_plus_conv @{cterm "-1234::int"} @{cterm "-5678::int"}\<close>
ML \<open>int_plus_conv @{cterm "-1234::int"} @{cterm "1::int"}\<close>
ML \<open>int_plus_conv @{cterm "1::int"} @{cterm "-1234::int"}\<close>
ML \<open>int_plus_conv @{cterm "1::int"} @{cterm "1::int"}\<close>
ML \<open>int_plus_conv @{cterm "2::int"} @{cterm "-1::int"}\<close>

ML \<open>int_minus_conv @{cterm "1234::int"} @{cterm "5678::int"}\<close>
ML \<open>int_minus_conv @{cterm "-1234::int"} @{cterm "5678::int"}\<close>
ML \<open>int_minus_conv @{cterm "1234::int"} @{cterm "-5678::int"}\<close>
ML \<open>int_minus_conv @{cterm "-1234::int"} @{cterm "-5678::int"}\<close>
ML \<open>int_minus_conv @{cterm "-1234::int"} @{cterm "1::int"}\<close>
ML \<open>int_minus_conv @{cterm "1::int"} @{cterm "-1234::int"}\<close>
ML \<open>int_minus_conv @{cterm "1::int"} @{cterm "1::int"}\<close>
ML \<open>int_minus_conv @{cterm "2::int"} @{cterm "1::int"}\<close>
ML \<open>int_minus_conv @{cterm "0::int"} @{cterm "1234::int"}\<close>
ML \<open>int_minus_conv @{cterm "0::int"} @{cterm "-1234::int"}\<close>

ML \<open>nat_minus_conv @{cterm "4567::nat"} @{cterm "1234::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "1234::nat"} @{cterm "4567::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "2::nat"} @{cterm "1::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "1::nat"} @{cterm "2::nat"}\<close>

ML \<open>nat_mult_conv @{cterm "123::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_mult_conv @{cterm "123::nat"} @{cterm "0::nat"}\<close>
ML \<open>nat_mult_conv @{cterm "123::nat"} @{cterm "1::nat"}\<close>
ML \<open>nat_mult_conv @{cterm "1::nat"} @{cterm "1::nat"}\<close>

ML \<open>int_mult_conv @{cterm "123::int"} @{cterm "456::int"}\<close>
ML \<open>int_mult_conv @{cterm "-123::int"} @{cterm "456::int"}\<close>
ML \<open>int_mult_conv @{cterm "123::int"} @{cterm "-456::int"}\<close>
ML \<open>int_mult_conv @{cterm "-123::int"} @{cterm "-456::int"}\<close>
ML \<open>int_mult_conv @{cterm "-1::int"} @{cterm "-1::int"}\<close>

ML \<open>nat_eq_conv @{cterm "124::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "123::nat"} @{cterm "123::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "123::nat"} @{cterm "1::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "0::nat"} @{cterm "123::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "123::nat"} @{cterm "0::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "0::nat"} @{cterm "0::nat"}\<close>

ML \<open>int_eq_conv @{cterm "123::int"} @{cterm "456::int"}\<close>
ML \<open>int_eq_conv @{cterm "123::int"} @{cterm "123::int"}\<close>
ML \<open>int_eq_conv @{cterm "123::int"} @{cterm "-123::int"}\<close>
ML \<open>int_eq_conv @{cterm "-123::int"} @{cterm "123::int"}\<close>
ML \<open>int_eq_conv @{cterm "-1::int"} @{cterm "1::int"}\<close>
ML \<open>int_eq_conv @{cterm "1::int"} @{cterm "-1::int"}\<close>
ML \<open>int_eq_conv @{cterm "0::int"} @{cterm "-1::int"}\<close>

ML \<open>nat_le_conv @{cterm "123::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_le_conv @{cterm "123::nat"} @{cterm "1::nat"}\<close>
ML \<open>nat_le_conv @{cterm "1::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_le_conv @{cterm "0::nat"} @{cterm "0::nat"}\<close>

ML \<open>int_le_conv @{cterm "-123::int"} @{cterm "123::int"}\<close>
ML \<open>int_le_conv @{cterm "-123::int"} @{cterm "1::int"}\<close>
ML \<open>int_le_conv @{cterm "-123::int"} @{cterm "-456::int"}\<close>

ML \<open>nat_less_conv @{cterm "123::nat"} @{cterm "456::nat"}\<close>

ML \<open>nat_less_conv @{cterm "1::nat"} @{cterm "2::nat"}\<close>
ML \<open>nat_less_conv @{cterm "42::nat"} @{cterm "99::nat"}\<close>
ML \<open>nat_less_conv @{cterm "99::nat"} @{cterm "42::nat"}\<close>
ML \<open>nat_less_conv @{cterm "123::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_less_conv @{cterm "654::nat"} @{cterm "321::nat"}\<close>

ML \<open>nat_minus_conv @{cterm "99::nat"} @{cterm "88::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "3::nat"} @{cterm "2::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "33::nat"} @{cterm "33::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "42::nat"} @{cterm "55::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "42::nat"} @{cterm "37::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "98765432109876543210::nat"} @{cterm "9876543210987654321::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "1000::nat"} @{cterm "1::nat"}\<close>
ML \<open>nat_minus_conv @{cterm "1000::nat"} @{cterm "0::nat"}\<close>

ML \<open>nat_plus_conv @{cterm "123::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_plus_conv @{cterm "9876543210987654321::nat"} @{cterm "88888888898888888889::nat"}\<close>
ML \<open>nat_plus_conv @{cterm "999::nat"} @{cterm "1::nat"}\<close>
ML \<open>nat_plus_conv @{cterm "0::nat"} @{cterm "99::nat"}\<close>

ML \<open>nat_eq_conv @{cterm "123::nat"} @{cterm "456::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "1234567890::nat"} @{cterm "1234567890::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "1234567899::nat"} @{cterm "1234567890::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "1234567890::nat"} @{cterm "3234567890::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "0::nat"} @{cterm "123::nat"}\<close>
ML \<open>nat_eq_conv @{cterm "123::nat"} @{cterm "1::nat"}\<close>

ML \<open>int_plus_conv @{cterm "123::int"} @{cterm "456::int"}\<close>
ML \<open>int_plus_conv @{cterm "123::int"} @{cterm "-456::int"}\<close>
ML \<open>int_plus_conv @{cterm "-123::int"} @{cterm "456::int"}\<close>
ML \<open>int_plus_conv @{cterm "123::int"} @{cterm "1::int"}\<close>
ML \<open>int_plus_conv @{cterm "-1::int"} @{cterm "2::int"}\<close>

ML \<open>int_minus_conv @{cterm "123::int"} @{cterm "456::int"}\<close>
ML \<open>int_minus_conv @{cterm "123::int"} @{cterm "-456::int"}\<close>
ML \<open>int_minus_conv @{cterm "-123::int"} @{cterm "456::int"}\<close>
ML \<open>int_minus_conv @{cterm "123::int"} @{cterm "1::int"}\<close>
ML \<open>int_minus_conv @{cterm "-1::int"} @{cterm "2::int"}\<close>

ML \<open>int_mult_conv @{cterm "123::int"} @{cterm "456::int"}\<close>
ML \<open>int_mult_conv @{cterm "123::int"} @{cterm "-456::int"}\<close>
ML \<open>int_mult_conv @{cterm "-123::int"} @{cterm "456::int"}\<close>
ML \<open>int_mult_conv @{cterm "123::int"} @{cterm "1::int"}\<close>
ML \<open>int_mult_conv @{cterm "-1::int"} @{cterm "2::int"}\<close>

ML \<open>int_neg_conv @{cterm "1234::int"}\<close>
ML \<open>int_neg_conv @{cterm "-1234::int"}\<close>
ML \<open>int_neg_conv @{cterm "-1::int"}\<close>
ML \<open>int_neg_conv @{cterm "1::int"}\<close>
ML \<open>int_neg_conv @{cterm "0::int"}\<close>

ML \<open>int_eq_conv @{cterm "123::int"} @{cterm "456::int"}\<close>
ML \<open>int_eq_conv @{cterm "123::int"} @{cterm "123::int"}\<close>
ML \<open>int_eq_conv @{cterm "123::int"} @{cterm "1::int"}\<close>
