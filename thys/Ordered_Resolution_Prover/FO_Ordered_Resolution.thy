...
proof (cases rule: ord_resolve.cases)
  ...
  \<comment> \<open>Split side premises CAs'' into Cs'' and AAs''\<close>
  ...
  \<comment> \<open>Split main premise DA'' into D'' and As''\<close>
...
proof (cases rule: ord_resolve.cases)
  ...
  \<comment> \<open>Lifting AAs's non-emptiness\<close>
