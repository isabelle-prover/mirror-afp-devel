...
(* Authors: Burkhart Wolff (slight modifications)                             *)
(* Emails: simon.foster@york.ac.uk frank.zeyda@york.ac.uk                     *)
(******************************************************************************)
(* LAST REVIEWED: 7/12/2016 *)

text\<open> This file is an except from the "Optics" module of the AFP 
      \<^url>\<open>https://www.isa-afp.org/entries/Optics.html\<close>. \<close>
...
lemma lens_indep_sym':  "(x \<bowtie> y) = (y \<bowtie> x)"
