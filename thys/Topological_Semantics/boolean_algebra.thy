...
hide_const(open) List.list.Nil unbundle no list_syntax (*We have no use for lists... *)
...
hide_const(open) Groups.uminus_class.uminus unbundle no uminus_syntax (*we don't use this*)
(*-----------------------------------*)
