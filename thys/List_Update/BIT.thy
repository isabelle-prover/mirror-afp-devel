...
section "Upper Bound on the Cost of BIT"
...
subsection "The Transformation"
    ...
    proof (rule, goal_cases)
      ...
      subsubsection "Upper bound of the inversions created by paid exchanges of A"
   ...
   then if s'_A n m ! (paid_A ! n ! ?revm) < s'_A n m ! Suc (paid_A ! n ! ?revm) in ys
      ...
      subsubsection "Upper bound for inversions generated by free exchanges"
...
subsection "Approximation of the Term for Free exchanges"
    ...
    next
      ...
      subsubsection "Transformation of the first term" 
      ...
      subsubsection "Transformation of the second term"       
      ...
      subsubsection "Equational transformations to the goal" 
...
subsection "Transformation of the Term for Paid Exchanges"
...
subsection "Combine the Results"
...
section "Generalize Competitivness of BIT"
