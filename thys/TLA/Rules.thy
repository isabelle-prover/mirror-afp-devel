...
theorem nex: assumes h1: "\<turnstile> F" shows "|~ \<circ>F"
...
theorem ax3:
  assumes H: "|~ F \<and> Unchanged v \<longrightarrow> \<circ>F" 
  shows "\<turnstile> \<box>[F \<longrightarrow> \<circ>F]_v \<longrightarrow> (F \<longrightarrow> \<box>F)"
proof (clarsimp simp: always_def)
  fix w n
  assume a1: "w \<Turnstile> \<box>[F \<longrightarrow> \<circ>F]_v" and  a2: "w \<Turnstile> F"
...
theorem pax1 [simp_unl]: "|~ (\<circ>\<not>F) = (\<not>\<circ>F)"
  by (auto simp: nexts_def)

theorem pax2: "|~ \<circ>(F \<longrightarrow> G) \<longrightarrow> (\<circ>F \<longrightarrow> \<circ>G)"
  by (auto simp: nexts_def)

theorem pax3: "|~ \<box>F \<longrightarrow> \<circ>\<box>F"
  by (auto simp: always_def nexts_def tail_def suffix_plus)

theorem pax4: "|~ \<box>[P]_v = ([P]_v \<and> \<circ>\<box>[P]_v)"
proof (auto)
  fix w
...
next
  fix w
  assume "w \<Turnstile> \<box>[P]_v"
  thus "w \<Turnstile> \<circ>\<box>[P]_v" by (auto simp: nexts_def action_def tail_def suffix_plus)
next
  fix w
  assume 1: "w \<Turnstile> [P]_v" and 2: "w \<Turnstile> \<circ>\<box>[P]_v"
...
theorem pax5: "|~ \<circ>\<box>F \<longrightarrow> \<box>[\<circ>F]_v"
...
text{* 
  ...
  hypothesis @{term "|~ F \<and> Unchanged v \<longrightarrow> \<circ>F"}.
*}

theorem alw2: 
  assumes h1: "\<turnstile> F" and h2: "|~ F \<and> Unchanged v \<longrightarrow> \<circ>F"
  shows "\<turnstile> \<box>F"
proof -
  from h1 have g2: "|~ \<circ>F" by (rule nex)
  hence g3: "|~ F \<longrightarrow> \<circ>F" by auto
  hence g4:"\<turnstile> \<box>[(F \<longrightarrow> \<circ>F)]_v" by (rule sq)
  from h2 have "\<turnstile> \<box>[(F \<longrightarrow> \<circ>F)]_v \<longrightarrow> F \<longrightarrow> \<box>F" by (rule ax3)
...
theorem alw3:
  ...
  shows "\<turnstile> \<box>F"
proof -
  from h2 have "|~ F \<and> Unchanged id \<longrightarrow> \<circ>F"  by (rule pre_id_unch)
...
proof -
  have 1: "|~ \<box>[P]_v \<longrightarrow> \<circ>\<box>[P]_v" using pax4 by force
  hence "\<turnstile> \<box>[\<box>[P]_v \<longrightarrow> \<circ>\<box>[P]_v]_v" by (rule sq)
  moreover
  have "\<turnstile> \<box>[ \<box>[P]_v \<longrightarrow> \<circ>\<box>[P]_v ]_v \<longrightarrow> \<box>[P]_v \<longrightarrow> \<box>\<box>[P]_v"
...
theorem N1:
  ...
  shows "|~ \<circ>F \<longrightarrow> \<circ>G"
...
theorem T6: "\<turnstile> \<box>F \<longrightarrow> \<box>[\<circ>F]_v"
proof -
  from ax1 have "|~ \<circ>(\<box>F \<longrightarrow> F)" by (rule nex)
  with pax2 have "|~ \<circ>\<box>F \<longrightarrow> \<circ>F" by force
  with pax3 have "|~ \<box>F \<longrightarrow> \<circ>F" by (rule pref_imp_trans)
  hence "\<turnstile> \<box>[\<box>F]_v \<longrightarrow> \<box>[\<circ>F]_v" by (rule M2)
  with ax2 show ?thesis by (rule lift_imp_trans)
qed

theorem T7: 
  assumes h: "|~ F \<and> Unchanged v \<longrightarrow> \<circ>F"
  shows "|~ (F \<and> \<circ>\<box>F) = \<box>F"
proof -
  have "\<turnstile> \<box>[\<circ>F \<longrightarrow> F \<longrightarrow> \<circ>F]_v" by (rule sq) auto
  with ax4 have "\<turnstile> \<box>[\<circ>F]_v \<longrightarrow> \<box>[(F \<longrightarrow> \<circ>F)]_v" by force
  with ax3[OF h, unlifted] have "\<turnstile> \<box>[\<circ>F]_v \<longrightarrow> (F \<longrightarrow> \<box>F)" by force
  with pax5 have "|~ F \<and> \<circ>\<box>F \<longrightarrow> \<box>F" by force
  with ax1[of "TEMP F",unlifted] pax3[of "TEMP F",unlifted] show ?thesis by force
qed

theorem T8: "|~ \<circ>(F \<and> G) = (\<circ>F \<and> \<circ>G)"
proof -
  have "|~ \<circ>(F \<and> G) \<longrightarrow> \<circ>F" by (rule N1) auto
  moreover
  have "|~ \<circ>(F \<and> G) \<longrightarrow> \<circ>G" by (rule N1) auto
  moreover
  have "\<turnstile> F \<longrightarrow> G \<longrightarrow> F \<and> G" by auto
  from nex[OF this] have "|~ \<circ>F \<longrightarrow> \<circ>G \<longrightarrow> \<circ>(F \<and> G)" 
...
theorem H5: "\<turnstile> \<box>[\<box>F \<longrightarrow> \<circ>\<box>F]_v"
  by (rule pax3[THEN sq])

subsection "Some other useful derived theorems"

theorem P1: "|~ \<box>F \<longrightarrow> \<circ>F"
proof -
  have "|~ \<circ>\<box>F \<longrightarrow> \<circ>F" by (rule N1[OF ax1])
  with pax3 show ?thesis by (rule pref_imp_trans)
qed

theorem P2: "|~ \<box>F \<longrightarrow> F \<and> \<circ>F"
...
theorem M0: "\<turnstile> \<box>F \<longrightarrow> \<box>[F \<longrightarrow> \<circ>F]_v" 
proof -
  from P1 have "|~ \<box>F \<longrightarrow> F \<longrightarrow> \<circ>F" by force 
  hence "\<turnstile> \<box>[\<box>F]_v \<longrightarrow> \<box>[F \<longrightarrow> \<circ>F]_v" by (rule M2)
  with ax2 show ?thesis by (rule lift_imp_trans)
qed

theorem M1: "\<turnstile> \<box>F \<longrightarrow> \<box>[F \<and> \<circ>F]_v"
proof -
  have "|~ \<box>F \<longrightarrow> F \<and> \<circ>F" by (rule P2)
  hence "\<turnstile> \<box>[\<box>F]_v \<longrightarrow> \<box>[F \<and> \<circ>F]_v" by (rule M2)
  with ax2 show ?thesis by (rule lift_imp_trans)
qed

theorem M3: assumes h: "\<turnstile> F" shows "\<turnstile> \<box>[\<circ>F]_v"
  using alw[OF h] T6 by (rule fmp)

lemma M4: "\<turnstile> \<box>[\<circ>(F \<and> G) = (\<circ>F \<and> \<circ>G)]_v"
  by (rule sq[OF T8])

theorem M5: "\<turnstile> \<box>[ \<box>[P]_v \<longrightarrow> \<circ>\<box>[P]_v ]_w"
proof (rule sq)
  show "|~ \<box>[P]_v \<longrightarrow> \<circ>\<box>[P]_v" by (auto simp: pax4[unlifted])
qed
...
theorem M9: "|~ \<box>F \<longrightarrow> F \<and> \<circ>\<box>F"
  using pre[OF ax1[of "F"]] pax3[of "F"] by force

theorem M10: 
  assumes h: "|~ F \<and> Unchanged v \<longrightarrow> \<circ>F"
  shows "|~ F \<and> \<circ>\<box>F \<longrightarrow> \<box>F"
...
theorem STL4_2: 
  assumes h1: "\<turnstile> F \<longrightarrow> G" and h2: "|~ G \<and> Unchanged v \<longrightarrow> \<circ>G"
  shows "\<turnstile> \<box>F \<longrightarrow> \<box>G"
proof -
  from ax1[of F] h1 have "\<turnstile> \<box>F \<longrightarrow> G" by (rule lift_imp_trans)
  moreover
  from h1 have "|~ \<circ>F \<longrightarrow> \<circ>G" by (rule N1)
  hence "|~ \<circ>F \<longrightarrow> G \<longrightarrow> \<circ>G" by auto
  hence "\<turnstile> \<box>[\<circ>F]_v \<longrightarrow> \<box>[G \<longrightarrow> \<circ>G]_v" by (rule M2)
  with T6 have "\<turnstile> \<box>F \<longrightarrow> \<box>[G \<longrightarrow> \<circ>G]_v" by (rule lift_imp_trans)
  moreover
  from h2 have "\<turnstile> \<box>[G \<longrightarrow> \<circ>G]_v \<longrightarrow> G \<longrightarrow> \<box>G" by (rule ax3)
  ultimately
...
theorem STL5_2: 
  assumes h1: "|~ F \<and> Unchanged f \<longrightarrow> \<circ>F"
      and h2: "|~ G \<and> Unchanged g \<longrightarrow> \<circ>G"
...
next
  ...
  have h3: "|~ (F \<and> G) \<and> Unchanged (f,g) \<longrightarrow> \<circ>(F \<and> G)" by force
  ...
  moreover
  from P1[of F] P1[of G] have "|~ \<box>F \<and> \<box>G \<longrightarrow> F \<and> G \<longrightarrow> \<circ>(F \<and> G)"
    unfolding T8[int_rewrite] by force
  hence "\<turnstile> \<box>[ \<box>F \<and> \<box>G ]_(f,g) \<longrightarrow> \<box>[F \<and> G \<longrightarrow> \<circ>(F \<and> G)]_(f,g)" by (rule M2)
...
theorem E7: 
  assumes h: "|~ \<not>F \<and> Unchanged v \<longrightarrow> \<circ>\<not>F"
  shows      "|~ \<diamond>F \<longrightarrow> F \<or> \<circ>\<diamond>F"
proof -
  from h have "|~ \<not>F \<and> \<circ>\<box>\<not>F \<longrightarrow> \<box>\<not>F" by (rule M10)
...
lemma E23: "|~ \<circ>F \<longrightarrow> \<diamond>F"
...
lemma E29: "|~ \<circ>\<diamond>F \<longrightarrow> \<diamond>F"
...
lemma LT23: "|~ (P \<longrightarrow> \<circ>Q) \<longrightarrow> (P \<longrightarrow> \<diamond>Q)"
...
lemma LT28: 
  assumes h: "|~ P \<longrightarrow> \<circ>P \<or> \<circ>Q"
  shows "|~ (P \<longrightarrow> \<circ>P) \<or> \<diamond>Q"
  using h E23[of Q] by force

lemma LT29:
  assumes h1: "|~ P \<longrightarrow> \<circ>P \<or> \<circ>Q" and   h2: "|~ P \<and> Unchanged v \<longrightarrow> \<circ>P"
  shows "\<turnstile> P \<longrightarrow> \<box>P \<or> \<diamond>Q"
proof -
  from h1[THEN LT28] have "|~ \<box>\<not>Q \<longrightarrow> (P \<longrightarrow> \<circ>P)" unfolding eventually_def by auto
  hence "\<turnstile> \<box>[\<box>\<not>Q]_v \<longrightarrow> \<box>[P \<longrightarrow> \<circ>P]_v" by (rule M2)
  moreover
...
lemma LT30:
  assumes h: "|~ P \<and> N \<longrightarrow> \<circ>P \<or> \<circ>Q"
  shows "|~ N \<longrightarrow> (P \<longrightarrow> \<circ>P) \<or> \<diamond>Q"
  using h E23 by force

lemma LT31:
  assumes h1: "|~ P \<and> N \<longrightarrow> \<circ>P \<or> \<circ>Q" and h2: "|~ P \<and> Unchanged v \<longrightarrow> \<circ>P"
  shows"\<turnstile> \<box>N \<longrightarrow> P \<longrightarrow> \<box>P \<or> \<diamond>Q"
proof -
  from h1[THEN LT30] have "|~ N \<longrightarrow> \<box>\<not>Q \<longrightarrow> P \<longrightarrow> \<circ>P" unfolding eventually_def by auto
  hence "\<turnstile> \<box>[N \<longrightarrow> \<box>\<not>Q \<longrightarrow> P \<longrightarrow> \<circ>P]_v" by (rule sq)
  hence "\<turnstile> \<box>[N]_v \<longrightarrow> \<box>[\<box>\<not>Q]_v \<longrightarrow> \<box>[P \<longrightarrow> \<circ>P]_v"
    by (force intro: ax4[unlift_rule])
  with P4 have "\<turnstile> \<box>N \<longrightarrow> \<box>[\<box>\<not>Q]_v \<longrightarrow> \<box>[P \<longrightarrow> \<circ>P]_v" by (rule lift_imp_trans)
  moreover
  have "\<turnstile> \<not>\<diamond>Q \<longrightarrow> \<box>[\<box>\<not>Q]_v" unfolding dualization_rew by (rule ax2)
  moreover
  note ax3[OF h2]
...
lemma AA20: 
  assumes h1: "|~ P \<longrightarrow> \<circ>P \<or> \<circ>Q"
     and  h2: "|~ P \<and> A \<longrightarrow> \<circ>Q"
     and  h3: "|~ P \<and> Unchanged w \<longrightarrow> \<circ>P" 
...
lemma AA21: "|~ \<diamond>\<langle>\<circ>F\<rangle>_v \<longrightarrow> \<circ>\<diamond>F"
...
proof -
  from h2 have "|~ \<langle>(N \<and> P) \<and> A\<rangle>_v \<longrightarrow> \<circ>Q" by (auto simp: angle_actrans_sem[int_rewrite])
...
lemma AA23:
  assumes "|~ P \<and> N \<longrightarrow> \<circ>P \<or> \<circ>Q"
     and  "|~ P \<and> N \<and> \<langle>A\<rangle>_v \<longrightarrow> \<circ>Q"
     and  "|~ P \<and> Unchanged w \<longrightarrow> \<circ>P"
...
theorem AA31: "\<turnstile> \<diamond>\<langle>\<circ>F\<rangle>_v \<longrightarrow> \<diamond>F"
...
lemma N2: assumes h: "\<turnstile> F = G" shows "|~ \<circ>F = \<circ>G"
  by (simp add: h[int_rewrite])

lemmas next_and = T8

lemma next_or: "|~ \<circ>(F \<or> G) = (\<circ>F \<or> \<circ>G)"
proof (rule pref_iffI)
  have "|~ \<circ>((F \<or> G) \<and> \<not>F) \<longrightarrow> \<circ>G" by (rule N1) auto
  thus "|~ \<circ>(F \<or> G) \<longrightarrow> \<circ>F \<or> \<circ>G" by (auto simp: T8[int_rewrite])
next
  have "|~ \<circ>F \<longrightarrow> \<circ>(F \<or> G)" by (rule N1) auto
  moreover have "|~ \<circ>G \<longrightarrow> \<circ>(F \<or> G)" by (rule N1) auto
  ultimately show "|~ \<circ>F \<or> \<circ>G \<longrightarrow> \<circ>(F \<or> G)" by force
qed

lemma next_imp: "|~ \<circ>(F \<longrightarrow> G) = (\<circ>F \<longrightarrow> \<circ>G)"
proof (rule pref_iffI)
  have "|~ \<circ>G \<longrightarrow> \<circ>(F \<longrightarrow> G)" by (rule N1) auto
  moreover have "|~ \<circ>\<not>F \<longrightarrow> \<circ>(F \<longrightarrow> G)" by (rule N1) auto
  ultimately show "|~ (\<circ>F \<longrightarrow> \<circ>G) \<longrightarrow> \<circ>(F \<longrightarrow> G)" by force
qed (rule pax2)

lemmas next_not = pax1

lemma next_eq: "|~ \<circ>(F = G) = (\<circ>F = \<circ>G)"
proof -
  have "|~ \<circ>(F = G) = \<circ>((F \<longrightarrow> G) \<and> (G \<longrightarrow> F))" by (rule N2) auto
  from this[int_rewrite] show ?thesis
    by (auto simp: next_and[int_rewrite] next_imp[int_rewrite])
qed

lemma next_noteq: "|~ \<circ>(F \<noteq> G) = (\<circ>F \<noteq> \<circ>G)"
  by (simp add: next_eq[int_rewrite])

lemma next_const[simp_unl]: "|~ \<circ>#P = #P"
proof (cases "P")
  assume "P"
  hence 1: "\<turnstile> #P" by auto
  hence "|~ \<circ>#P" by (rule nex)
  with 1 show ?thesis by force
next
  assume "\<not>P"
  hence 1: "\<turnstile> \<not>#P" by auto
  hence "|~ \<circ>\<not>#P" by (rule nex)
  with 1 show ?thesis by force
qed
...
*}
lemma next_fun1: "|~ \<circ>f<x> = f<\<circ>x>"
  by (auto simp: nexts_def)

lemma next_fun2: "|~ \<circ>f<x,y> = f<\<circ>x,\<circ>y>"
  by (auto simp: nexts_def)

lemma next_fun3: "|~ \<circ>f<x,y,z> = f<\<circ>x,\<circ>y,\<circ>z>"
  by (auto simp: nexts_def)

lemma next_fun4: "|~ \<circ>f<x,y,z,zz> = f<\<circ>x,\<circ>y,\<circ>z,\<circ>zz>"
  by (auto simp: nexts_def)

lemma next_forall: "|~ \<circ>(\<forall> x. P x) = (\<forall> x. \<circ> P x)"
  by (auto simp: nexts_def)

lemma next_exists: "|~ \<circ>(\<exists> x. P x) = (\<exists> x. \<circ> P x)"
  by (auto simp: nexts_def)

lemma next_exists1: "|~ \<circ>(\<exists>! x. P x) = (\<exists>! x. \<circ> P x)"
  by (auto simp: nexts_def)
...
lemma next_eventually:
  assumes h: "stutinv F"
  shows "|~ \<diamond>F \<longrightarrow> \<not>F \<longrightarrow> \<circ>\<diamond>F"
proof -
  from h have 1: "stutinv (TEMP \<not>F)" by (rule stut_not)
  have "|~ \<box>\<not>F = (\<not>F \<and> \<circ>\<box>\<not>F)" unfolding T7[OF pre_id_unch[OF 1], int_rewrite] by simp
  thus ?thesis by (auto simp: eventually_def)
qed

lemma next_action: "|~ \<box>[P]_v \<longrightarrow> \<circ>\<box>[P]_v"
...
theorem TLA1: 
  assumes H: "|~ P \<and> Unchanged f \<longrightarrow> \<circ>P" 
  shows "\<turnstile> \<box>P = (P \<and> \<box>[P \<longrightarrow> \<circ>P]_f)"
proof (rule int_iffI)
  from ax1[of P] M0[of P f] show "\<turnstile> \<box>P \<longrightarrow> P \<and> \<box>[P \<longrightarrow> \<circ>P]_f" by force
next
  from ax3[OF H] show "\<turnstile> P \<and> \<box>[P \<longrightarrow> \<circ>P]_f \<longrightarrow> \<box>P" by auto
qed

theorem TLA2:
  assumes h1: "\<turnstile> P \<longrightarrow> Q"
      and h2: "|~ P \<and> \<circ>P \<and> [A]_f \<longrightarrow> [B]_g"
  shows "\<turnstile> \<box>P \<and> \<box>[A]_f \<longrightarrow> \<box>Q \<and> \<box>[B]_g"
proof -
  from h2 have "\<turnstile> \<box>[P \<and> \<circ>P \<and> [A]_f]_g \<longrightarrow> \<box>[[B]_g]_g" by (rule M2)
  hence "\<turnstile> \<box>[P \<and> \<circ>P]_g \<and> \<box>[[A]_f]_g \<longrightarrow> \<box>[B]_g" by (auto simp add: M8[int_rewrite])
...
theorem INV1: 
  assumes H: "|~ I \<and> [N]_f \<longrightarrow> \<circ>I"
  shows "\<turnstile> I \<and> \<box>[N]_f \<longrightarrow> \<box>I"
proof -
  from H have "|~ [N]_f \<longrightarrow> I \<longrightarrow> \<circ>I" by auto
  hence "\<turnstile> \<box>[[N]_f]_f \<longrightarrow> \<box>[I \<longrightarrow> \<circ>I]_f" by (rule M2)
  moreover
  from H have "|~ I \<and> Unchanged f \<longrightarrow> \<circ>I" by (auto simp: actrans_def)
  hence "\<turnstile> \<box>[I \<longrightarrow> \<circ>I]_f \<longrightarrow> I \<longrightarrow> \<box>I" by (rule ax3)
  ultimately show ?thesis by force
qed

theorem INV2: "\<turnstile> \<box>I \<longrightarrow> \<box>[N]_f = \<box>[N \<and> I \<and> \<circ>I]_f"
proof -
  from M1[of I f] have "\<turnstile> \<box>I \<longrightarrow> (\<box>[N]_f = \<box>[N]_f \<and> \<box>[I \<and> \<circ>I]_f)" by auto
...
theorem invmono:
  assumes h1: "\<turnstile> I \<longrightarrow> P"
      and h2: "|~ P \<and> [N]_f \<longrightarrow> \<circ>P" 
...
theorem refinement1: 
  assumes h1: "\<turnstile> P \<longrightarrow> Q"
      and h2: "|~ I \<and> \<circ>I \<and> [A]_f \<longrightarrow> [B]_g"
