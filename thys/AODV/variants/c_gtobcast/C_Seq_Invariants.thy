...
lemma dests_bigger_than_sqn:
  "paodv i \<TTurnstile> onl \<Gamma>\<^sub>A\<^sub>O\<^sub>D\<^sub>V (\<lambda>(\<xi>, l). l \<in> {PAodv-:15..PAodv-:17}
                                 \<union> {PPkt-:7..PPkt-:9}
                                 \<union> {PRreq-:9..PRreq-:11}
                                 \<union> {PRreq-:17..PRreq-:19}
                                 \<union> {PRrep-:8..PRrep-:10}
...
lemma rreq_dip_in_vD_dip_eq_ip:
  "paodv i \<TTurnstile> onl \<Gamma>\<^sub>A\<^sub>O\<^sub>D\<^sub>V (\<lambda>(\<xi>, l). (l \<in> {PRreq-:14} \<longrightarrow> dip \<xi> \<in> vD(rt \<xi>))
                            \<and> (l \<in> {PRreq-:5, PRreq-:6} \<longrightarrow> dip \<xi> = ip \<xi>)
                            \<and> (l \<in> {PRreq-:13..PRreq-:14} \<longrightarrow> dip \<xi> \<noteq> ip \<xi>))"
  by inv_cterms
...
lemma rreq_rrep_sn_any_step_invariant:
  ...
  proof -
    ...
    have sqnf_kno: "paodv i \<TTurnstile> onl \<Gamma>\<^sub>A\<^sub>O\<^sub>D\<^sub>V (\<lambda>(\<xi>, l).
                                      (l \<in> {PRreq-:14} \<longrightarrow> dip \<xi> \<in> kD (rt \<xi>) \<and> sqnf (rt \<xi>) (dip \<xi>) = kno))"
      by (inv_cterms)
    show ?thesis
...
lemma rreq_rrep_fresh_any_step_invariant:
  ...
  proof -                                                      
    have rreq_oip: "paodv i \<TTurnstile> onl \<Gamma>\<^sub>A\<^sub>O\<^sub>D\<^sub>V (\<lambda>(\<xi>, l).
                       (l \<in> {PRreq-:3, PRreq-:4, PRreq-:13, PRreq-:21}
    ...
    have rrep_prrep: "paodv i \<TTurnstile> onl \<Gamma>\<^sub>A\<^sub>O\<^sub>D\<^sub>V (\<lambda>(\<xi>, l).
          (l \<in> {PRrep-:2..PRrep-:5} \<longrightarrow> (dip \<xi> \<in> kD(rt \<xi>)
    ...
    have dests_inv: "paodv i \<TTurnstile>
                      onl \<Gamma>\<^sub>A\<^sub>O\<^sub>D\<^sub>V (\<lambda>(\<xi>, l). (l \<in> {PAodv-:15, PPkt-:7, PRreq-:9,
                         ...
                         \<and> (l \<in> {PAodv-:16..PAodv-:17}
                              \<union> {PPkt-:8..PPkt-:9}
                              \<union> {PRreq-:10..PRreq-:11}
                              \<union> {PRreq-:18..PRreq-:19}
                              \<union> {PRrep-:9..PRrep-:10}
...
lemma dests_vD_inc_sqn:
  "paodv i \<TTurnstile>
        onl \<Gamma>\<^sub>A\<^sub>O\<^sub>D\<^sub>V (\<lambda>(\<xi>, l). (l \<in> {PAodv-:15, PPkt-:7, PRreq-:9, PRreq-:17, PRrep-:8}
