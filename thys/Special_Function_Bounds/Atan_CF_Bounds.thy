...
proof -
  have *: "\<And>x::real.  (15 + 70 * x\<^sup>2 + 63 * x ^ 4) > 0"
    by (sos_cert "((R<1 + ((R<1 * ((R<7/8 * [19/7*x^2 + 1]^2) + ((R<4 * [x]^2) + (R<10/7 * [x^2]^2)))) + ((A<=0 * R<1) * (R<1/8 * [1]^2)))))")
...
proof -
  have *: "\<And>x::real. (35 + 315 * x\<^sup>2 + 693 * x ^ 4 + 429 * x ^ 6) > 0"
    by (sos_cert "((R<1 + ((R<1 * ((R<13/8589934592 * [95/26*x^2 + 1]^2) + ((R<38654705675/4294967296 * [170080704731/154618822700*x^3 + x]^2) + ((R<14271/446676598784 * [x^2]^2) + (R<3631584276674589067439/2656331147370089676800 * [x^3]^2))))) + ((A<=0 * R<1) * (R<245426703/8589934592 * [1]^2)))))")
